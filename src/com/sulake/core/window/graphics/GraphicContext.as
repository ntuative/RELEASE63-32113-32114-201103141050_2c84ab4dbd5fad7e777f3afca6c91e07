package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1836:uint = 64;
      
      public static const const_1737:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_543:uint = 0;
      
      protected static var var_327:uint = 0;
      ...
      protected var var_818:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_190:Shape;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_208.numChildren > 0)
               {
                  this.var_208.removeChildAt(0);
               }
            }
            this.var_208 = null;
            while(numChildren > 0)
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_190)
            {
               this.var_190 = new Shape();
               this.var_190.visible = false;
               this.var_190.cacheAsBitmap = true;
               super.addChild(this.var_190);
            }
            this.var_190.graphics.clear();
            this.var_190.graphics.beginFill(255);
            this.var_190.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_190.graphics.endFill();
            this.getDisplayObject().mask = this.var_190;
         }
         else if(this.var_190)
         {
            super.removeChild(this.var_190);
            this.var_190.graphics.clear();
            this.var_190 = null;
         ...
         if(this.var_818)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_327 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2021,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2021,16777215);
                  }
                  var_327 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_818)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_327 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_208 == null)
         {
            this.var_208 = new Sprite();
            this.var_208.name = this.name + " - Child Container";
            this.var_208.mouseEnabled = false;
            addChild(this.var_208);
         }
         return this.var_208;
      }
      ...
      {
         return this.var_208 != null ? int(this.var_208.numChildren) : 0;
      }
