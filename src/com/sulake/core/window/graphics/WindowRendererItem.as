package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_916:uint = 1;
      
      private static const const_917:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1300 = 4294967295;
         this.var_852 = 0;
         this.var_1569 = new ColorTransform();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_917) : uint(const_586);
         var _loc6_:Boolean = this.var_178.width > 0 && this.var_178.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_852))
            {
               _loc5_ = const_916;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_916)
               {
                  ...
                  if(this.var_558)
                  {
                     ...
                     _loc7_.draw(param1,this.var_99,this.var_99.rect,this.var_852,false);
                  ...
                  {
                     this.var_1019.tx = param2.x;
                     this.var_1019.ty = param2.y;
                     this.var_1569.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_99,this.var_1019,this.var_1569,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc2_ = this.var_850.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_185);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_850.getTheActualState(param1.type,param1.style,param1.state) != this.var_1300;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1214:
               this.var_852 = this.var_850.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_852 != this.var_1300)
               {
                  this.var_558 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1042:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  this.var_558 = true;
                  _loc4_ = true;
