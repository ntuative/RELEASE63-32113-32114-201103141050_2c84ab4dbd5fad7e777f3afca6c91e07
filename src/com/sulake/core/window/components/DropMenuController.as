package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_264.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_520,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_614 = param1;
            this.closeMenuView();
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_342,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_185 == null || this.var_185.disposed)
         {
            this.var_185 = context.create(name + "::submenu","",WindowType.const_556,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_264.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_931 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_931)
         {
            if(this.open())
            {
               if(this.var_264.length)
               {
                  this.populateMenuItemContainer(this.var_264,this.getSubMenu(),this.subMenuEventProc);
                  this.var_931 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_931 = false;
            this.getTitleLabel().text = this.var_614 < this.var_264.length && this.var_614 > -1 ? this.var_264[this.var_614] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_450,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_398,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_614 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_614).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_498)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_61:
               ...
               break;
            case WindowTouchEvent.const_636:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1223,this,null);
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1202,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_264[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_264.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_820,this.var_264,PropertyStruct.const_147,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1441);
         }
         return _loc1_;
      }
