package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1333:String = "_HEADER";
      
      private static const const_1334:String = "_CONTENT";
      ...
      private var var_1437:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1437 = findChildByTag(const_1333) as IHeaderWindow;
            if(!this.var_1437)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_186 = findChildByTag(const_1334) as IWindowContainer;
            if(!this.var_186)
            {
      ...
      {
         return this.content != null && this.var_1011 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,_loc3_.left,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,_loc3_.top,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         }
         else
         {
