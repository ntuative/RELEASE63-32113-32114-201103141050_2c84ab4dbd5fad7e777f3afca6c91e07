package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1516:uint = 500;
      
      protected var var_1261:String = "";
      
      protected var var_1259:Boolean = false;
      ...
      {
         this.var_1261 = param1 == null ? "" : param1;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_498)
         {
            this.focus();
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_837,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1404);
         _loc1_.push(this.var_1259 != PropertyDefaults.const_984 ? new PropertyStruct(PropertyDefaults.const_788,this.var_1259,PropertyStruct.const_38,true) : PropertyDefaults.const_1393);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1115 ? new PropertyStruct(PropertyDefaults.const_846,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1541);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1216 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1409);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_788:
                  this.var_1259 = _loc2_.value as Boolean;
                  if(this.var_1259)
                  {
               ...
               case PropertyDefaults.const_837:
                  ...
                  break;
               case PropertyDefaults.const_1096:
