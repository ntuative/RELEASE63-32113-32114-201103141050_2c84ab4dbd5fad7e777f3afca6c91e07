package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1233:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_820:Number;
      
      protected var var_538:Number;
      
      protected var var_539:Boolean;
      ...
      protected var var_1016:Boolean = false;
      
      private var var_415:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_415,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_415 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_415,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_187);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_879 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_415);
      }
      ...
      {
         this.var_820 = param1;
         this._field.scrollH = this.var_820 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_820 * this.maxScrollH,this.var_538 * this.maxScrollV,width,height);
      }
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc7_ && !param1)
         {
            dispatchEvent(new WindowEvent(WindowEvent.const_51,this,null));
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_415);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_992) ? new PropertyStruct(PropertyDefaults.const_635,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1030) : PropertyDefaults.const_1444);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1129 ? new PropertyStruct(PropertyDefaults.const_763,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1132) : PropertyDefaults.const_1627);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_256,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_994 ? new PropertyStruct(PropertyDefaults.const_1082,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1034) : PropertyDefaults.const_1408);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_623) ? new PropertyStruct(PropertyDefaults.const_400,this._field.textColor,PropertyStruct.const_128,true) : PropertyDefaults.const_1130);
         _loc1_.push(this.var_415 != TextStyleManager.const_187 ? new PropertyStruct(PropertyDefaults.const_367,this.var_415,PropertyStruct.const_53,true,PropertyDefaults.const_743) : PropertyDefaults.const_1182);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_680 ? new PropertyStruct(PropertyDefaults.const_251,this.var_41.left,PropertyStruct.const_41,true) : PropertyDefaults.const_545);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_855 ? new PropertyStruct(PropertyDefaults.const_249,this.var_41.top,PropertyStruct.const_41,true) : PropertyDefaults.const_547);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_657 ? new PropertyStruct(PropertyDefaults.const_236,this.var_41.right,PropertyStruct.const_41,true) : PropertyDefaults.const_494);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_903 ? new PropertyStruct(PropertyDefaults.const_242,this.var_41.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_431);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1229 ? new PropertyStruct(PropertyDefaults.const_617,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1538);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_255,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_255,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_255,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
