package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1137:IItemListWindow;
      
      private var var_420:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_420)
         {
            this.var_420.removeEventListener(WindowEvent.const_286,this.scrollBarEventProc);
            this.var_420.removeEventListener(WindowEvent.const_222,this.scrollBarEventProc);
            this.var_420 = null;
         }
         if(this.var_1137)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1137)
         {
            this.var_1137 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_420)
         {
            this.var_420 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_420)
            {
               this.var_420.addEventListener(WindowEvent.const_286,this.scrollBarEventProc);
               this.var_420.addEventListener(WindowEvent.const_222,this.scrollBarEventProc);
            }
         }
         return this.var_420;
      }
