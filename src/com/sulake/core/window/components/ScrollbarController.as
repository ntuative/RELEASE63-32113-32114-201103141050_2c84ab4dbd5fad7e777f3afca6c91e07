package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1378:String = "increment";
      
      private static const const_1377:String = "decrement";
      
      private static const const_978:String = "slider_track";
      
      private static const const_611:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_664:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_20.removeEventListener(WindowEvent.const_51,this.onScrollableResized);
            this.var_20.removeEventListener(WindowEvent.const_476,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_51,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_476,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1001 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_978) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_611) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_611:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_319)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_664;
                  }
                  else
                  {
                     this.scrollV -= this.var_664;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_498)
         {
            ...
            else if(param2.name == const_1377)
            {
               if(this.var_20)
               {
                  this.var_1236 = true;
            ...
            else if(param2.name == const_978)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_611).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1001) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1001) as IScrollableWindow;
               if(_loc1_)
               {
