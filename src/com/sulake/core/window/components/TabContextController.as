package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1289:String = "_SELECTOR";
      
      private static const const_1290:String = "_CONTENT";
       
      
      protected var var_1015:ITabSelectorWindow;
      
      protected var var_2020:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1015 = findChildByTag(const_1289) as ITabSelectorWindow;
            if(this.var_1015 != null)
            {
               this.var_1015.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2020 = findChildByTag(const_1290) as IWindowContainer;
         }
      ...
      {
         return this.var_1015.numSelectables;
      }
