package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_415);
         if(_loc1_)
         {
      ...
      {
         if(this.var_415 != param1.name)
         {
            this.var_415 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2742 = _loc2_.textWidth;
         this.var_2743 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_380 != _loc2_.color : this.var_380 != null && this.var_380 != PropertyDefaults.const_623) ? new PropertyStruct(PropertyDefaults.const_400,this.var_380,PropertyStruct.const_128,true) : PropertyDefaults.const_1130);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_680)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,this.var_41.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_545);
            }
            if(this.var_41.top != PropertyDefaults.const_855)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,this.var_41.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_547);
            }
            if(this.var_41.right != PropertyDefaults.const_657)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,this.var_41.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_494);
            }
            if(this.var_41.bottom != PropertyDefaults.const_903)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,this.var_41.bottom,PropertyStruct.const_41,true));
            }
            else
            {
