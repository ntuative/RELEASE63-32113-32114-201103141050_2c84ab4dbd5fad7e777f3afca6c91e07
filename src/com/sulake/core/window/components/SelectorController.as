package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_207:ISelectableWindow;
      
      protected var var_2017:Boolean = true;
      ...
      {
         return this.var_207 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         ...
         if(param1 != null)
         {
            if(param1 != this.var_207)
            {
               if(this.var_207 != null)
               {
                  this.var_207.unselect();
               }
               this.var_207 = param1;
               this.var_207.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_342,this,this.var_207);
