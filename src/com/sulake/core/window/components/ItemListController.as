package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2033:Boolean = false;
      
      protected var var_541:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_2847:Number = 0.0;
      
      protected var var_2848:Number = 0.0;
      
      protected var var_1021:Boolean = true;
      
      protected var var_454:Boolean = false;
      
      protected var var_1265:Boolean = false;
      
      protected var var_2034:int = 0;
      
      protected var var_2035:int = 0;
      
      protected var var_1267:Number;
      
      protected var var_1268:Number;
      
      protected var var_1266:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_107 = 0;
         this.var_94 = 0;
         this._horizontal = param2 == WindowType.const_352;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_173 = var_450 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_398,WindowStyle.const_772,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_51,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_455,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_298,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_434,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1265;
      }
      ...
      {
         var _loc1_:int = this.var_107 - width;
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_662)
         {
            ...
            dispatchEvent(new WindowEvent(WindowEvent.const_476,this,null));
         }
      }
      ...
      {
         this.var_2847 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2848 = Math.max(param1,0);
      }
      
      public function set scaleToFitItems(param1:Boolean) : void
      {
         if(this.var_454 != param1)
         {
            this.var_454 = param1;
            this.updateScrollAreaRegion();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_488,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_51,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_455,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_298,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_434,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_190:
               if(this.var_1266)
               {
                  this.var_1267 = this.var_2034 - _loc3_;
                  this.var_1268 = this.var_2035 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1267 != 0 && this.var_107 != 0)
                     {
                        this.scrollH += this.var_1267 / this.var_107;
                     }
                  }
                  else if(this.var_1268 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1268 / this.var_94;
                  }
                  this.var_2034 = _loc3_;
                  this.var_2035 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_173:
               if(this.var_1266)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1267,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1268);
                  }
                  this.var_1266 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1021 && !this.var_541 && this._container)
         {
            this.var_541 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_693)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_385,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1054);
         }
         if(this.var_1021 != PropertyDefaults.const_1187)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_755,this.var_1021,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1471);
         }
         if(this.var_454 != PropertyDefaults.const_1167)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_882,this.var_454,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1460);
         }
         if(this.var_1265 != PropertyDefaults.const_1212)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_825,this.var_1265,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1604);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_755:
                  this.var_1021 = _loc2_.value as Boolean;
                  break;
            }
         }
