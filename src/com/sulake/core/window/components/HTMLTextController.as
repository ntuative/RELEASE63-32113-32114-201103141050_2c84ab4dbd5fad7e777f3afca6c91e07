package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_972:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_971:String = "default";
      
      private var var_1216:String = null;
      
      private var var_1901:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1216 == param2)
         {
            return;
         }
         param1.var_1216 = param2;
         param1.var_1901 = null;
         if(param1.var_1216 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1216);
            param1.var_1901 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_819.indexOf(param1) > -1)
         {
            this.var_971 = param1;
         }
      }
      ...
      {
         return this.var_971 == LinkTarget.const_32 ? defaultLinkTarget : this.var_971;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1901;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_795)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_971 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_831,this.var_971,PropertyStruct.const_53,true,PropertyDefaults.const_819));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1664);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_971 = _loc2_.value as String;
               break;
            }
