package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1149:String = "_EXCLUDE";
      
      public static const const_1863:String = "_INCLUDE";
      
      public static const const_1876:String = "_TEMP";
      
      private static const const_1355:String = "layout";
      
      private static const const_969:String = "window";
      
      private static const const_970:String = "variables";
      
      private static const const_971:String = "filters";
      
      private static const const_604:String = "name";
      
      private static const const_1346:String = "style";
      
      private static const const_606:String = "params";
      
      private static const const_1351:String = "tags";
      ...
      private static const const_1268:String = "height";
      
      private static const const_1356:String = "visible";
      
      private static const const_1358:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1042:String = "blend";
      
      private static const const_1345:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1352:String = "treshold";
      
      private static const const_1353:String = "children";
      
      private static const const_1349:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1357:String = "height_min";
      
      private static const const_1347:String = "height_max";
      
      private static const const_605:String = "HabboAchievementShareIdMessageParser";
      
      private static const const_166:String = "0";
      
      private static const const_1348:String = "$";
      
      private static const const_1267:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1354:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1350:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1264:Dictionary;
      
      protected var var_1263:Dictionary;
      
      protected var var_1020:Dictionary;
      
      protected var var_1517:Dictionary;
      
      protected var var_2031:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1264,this.var_1263);
         this.var_1020 = new Dictionary();
         this.var_1517 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1020,this.var_1517);
         this.var_2031 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1350,const_49);
         return param1.replace(const_1354,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1264)
            {
               delete this.var_1264[_loc1_];
            }
            for(_loc1_ in this.var_1263)
            {
               delete this.var_1263[_loc1_];
            }
            for(_loc1_ in this.var_1020)
            {
               delete this.var_1020[_loc1_];
            }
            for(_loc1_ in this.var_1517)
            {
               delete this.var_1517[_loc1_];
            }
            this.var_2031.dispose();
            this.var_2031 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1355)
         {
            _loc8_ = param1.child(const_970);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_971).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1264[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_604,variables,"")));
         style = uint(this.parseAttribute(xml,const_1346,variables,style));
         params = uint(this.parseAttribute(xml,const_606,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1351,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_166));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_166));
         rect.width = Number(this.parseAttribute(xml,const_1266,variables,const_166));
         rect.height = Number(this.parseAttribute(xml,const_1268,variables,const_166));
         visible = this.parseAttribute(xml,const_1356,variables,visible.toString()) == const_605;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_606).length() > 0)
         {
            list = xml.child(const_606).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_604,variables,"") as String;
               if(this.var_1020[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_604)) + "\"!");
               }
               params |= this.var_1020[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1358,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1267);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_970)[0]),tags) as WindowController;
         ...
         window.limits.minHeight = int(this.parseAttribute(xml,const_1357,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1347,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_605;
         blend = Number(this.parseAttribute(xml,const_1042,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1345,variables,window.clipping.toString()) == const_605;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1352,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_971).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_197)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1263[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1149) == -1)
                  {
