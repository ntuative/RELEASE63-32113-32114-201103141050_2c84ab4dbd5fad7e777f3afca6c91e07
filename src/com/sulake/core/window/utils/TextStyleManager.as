package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_187:String = "regular";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_85[const_187],var_85[ITALIC],var_85[BOLD]];
            var_85.reset();
            var_85[const_187] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_495.indexOf(_loc4_.name) == -1)
            {
               var_495.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "HabboAchievementShareIdMessageParser" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_597);
         if(countSubStrings(param1,const_596) != countSubStrings(param1,const_597))
         {
            throw new Error("Mismatching amount of \"" + const_596 + "\" versus \"" + const_597 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1306) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1305) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_596)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
