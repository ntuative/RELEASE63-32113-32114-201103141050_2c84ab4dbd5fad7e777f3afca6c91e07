package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1014 = new LoaderContext();
         this.var_1014.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1014);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_324 = 0;
         this.var_42.load(param1,this.var_1014);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_324 < var_2787)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1013 + (this.var_1013.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_324),this.var_1014);
               return true;
            }
         }
         return false;
