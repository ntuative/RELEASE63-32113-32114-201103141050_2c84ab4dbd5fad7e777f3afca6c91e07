package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_993:String = "AssetLibraryReady";
      
      public static const const_768:String = "AssetLibraryLoaded";
      
      public static const const_1677:String = "AssetLibraryUnloaded";
      
      public static const const_1422:String = "AssetLibraryLoadError";
      
      private static const const_604:String = "name";
      
      private static const const_949:String = "asset";
      
      private static const const_950:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_951:String = "library";
      
      private static var var_302:Dictionary;
      
      private static var var_1777:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_501:uint = 0;
      
      private static var var_927:Array = new Array();
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_612 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_951);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_949);
            _loc11_ = _loc5_.length();
            _loc12_ = 0;
            while(_loc12_ < _loc11_)
            {
               _loc6_ = _loc5_[_loc12_];
               _loc7_ = _loc6_.attribute(const_604);
               ...
               if(_loc8_ != null)
               {
                  ...
                  _loc10_ = _loc6_.child(const_950);
                  if(_loc10_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_612 + "!");
               }
               _loc12_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_927.splice(var_927.indexOf(this),1);
            --var_501;
            this.var_500 = null;
            this.var_929 = null;
            this.var_163 = null;
      ...
      {
         if(this.var_612 == param1.url && this.var_928)
         {
            if(!this.var_926 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_751,this.var_611);
            }
            this.var_926 = param2;
            dispatchEvent(new Event(AssetLibrary.const_993));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_928 = false;
         this.var_612 = null;
         dispatchEvent(new Event(AssetLibrary.const_1677));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_929[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return this.var_163[param1] != null || (this.var_611 != null ? this.var_611[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1777.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_751 = _loc2_.manifest.copy();
         this.var_611 = _loc2_.resource;
         this.var_612 = _loc2_.url;
         if(this.var_926)
         {
            AssetLibrary.fetchLibraryContents(this,this.var_751,this.var_611);
         }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1422));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_751.child(const_951);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_604).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_612 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_611[param1]);
                  _loc6_ = _loc3_.child(const_950);
                  if(_loc6_.length())
                  {
