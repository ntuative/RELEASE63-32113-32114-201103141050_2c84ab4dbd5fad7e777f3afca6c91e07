package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_544:uint = 0;
      
      protected static var var_460:uint = 0;
      ...
      private var var_1621:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_460 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_101 is BitmapDataAsset)
         {
            ...
            this.var_1427 = BitmapDataAsset(this.var_101).var_1427;
            this.var_1426 = BitmapDataAsset(this.var_101).var_1426;
            if(this._bitmap != null)
            {
               this.var_101 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1427 = _loc4_ == "1" || _loc4_ == "HabboAchievementShareIdMessageParser";
                  break;
               case "flipV":
                  this.var_1426 = _loc4_ == "1" || _loc4_ == "HabboAchievementShareIdMessageParser";
                  break;
            }
            _loc2_++;
         }
