package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1245:String = "asset-libraries";
      
      private static const const_1246:String = "library";
      
      private static const const_1251:String = "service-libraries";
      
      private static const const_1248:String = "library";
      
      private static const const_1247:String = "component-libraries";
      
      private static const const_1249:String = "library";
      
      private static const const_1244:String = "error_data";
      
      private static const const_1243:String = "error_cat";
      
      private static const const_1250:String = "error_desc";
       
      
      private var var_336:LibraryLoaderQueue;
      
      private var var_672:IEventDispatcher;
      
      private var var_468:uint;
      
      private var var_337:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1098:
               ...
               this.var_337 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_619:
               debug("Core; using complex frame update handler");
               this.var_337 = this.complexFrameUpdateHandler;
               break;
            case Core.const_759:
               debug("Core; using profiler frame update handler");
               this.var_337 = this.profilerFrameUpdateHandler;
               this.var_191 = new Profiler(this);
               attachComponent(this.var_191,[new IIDProfiler()]);
               var_448.addChild(new ProfilerViewer(this.var_191));
               break;
            case Core.const_480:
               debug("Core; using experimental frame update handler");
               this.var_337 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_337 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_336.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_468 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponentContext.const_102)
            {
               _loc2_ = this.var_241[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1243,String(param3));
         ErrorReportStorage.setParameter(const_1250,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_672 = loadingEventDelegate;
         if(this.var_336 == null)
         {
            this.var_336 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_327,e);
         }
         try
         {
            node = config.child(const_1251)[0];
            if(node != null)
            {
               list = node.child(const_1248);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_327,e);
         }
         try
         {
            node = config.child(const_1247)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_327,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1431);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_672)
         {
            this.var_672.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_672)
         {
            ...
            this.var_672.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_672)
                  {
                     this.var_672.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_468 - this.var_336.length,this.var_468,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_191 ? 0 : this.var_1292 & 0;
         if(_loc3_ == Core.const_480)
         {
            this.var_241[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_241[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_191 ? 0 : this.var_1292 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_102)
         {
            _loc3_ = this.var_241[_loc5_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_337(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_553[priority] = 0;
            receivers = this.var_241[priority];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_102)
         {
            ...
            {
               if(this.var_553[priority] < priority)
               {
                  ++this.var_553[priority];
                  skip = true;
               }
            }
            if(!skip)
