package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1569:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1494:String = "bool";
      ...
      private static const const_588:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_587:String = "value";
      
      private static const const_605:String = "HabboAchievementShareIdMessageParser";
      
      private static const const_1695:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_588));
         }
         else
         {
            _loc4_ = param1.child(const_588)[0];
         }
         ...
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_587));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_587)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_226 || _loc5_ == const_147)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1569:
               return Number(param1);
            case const_38:
               return param1 == const_605 || int(param1) > 0;
            case const_1494:
               return param1 == const_605 || int(param1) > 0;
            case const_128:
               return uint(param1);
            case const_147:
               return param1.split(const_1267);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_268:
               ...
               _loc5_.height = Number(param1.attribute(const_1268));
               return _loc5_;
            case const_147:
               _loc3_ = new Map();
