package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_590:Map = new Map();
      
      private static const const_329:Map = new Map();
      
      private static var var_1076:Boolean = false;
      ...
      {
         return const_590.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1076)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_590.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1076 = true;
         }
