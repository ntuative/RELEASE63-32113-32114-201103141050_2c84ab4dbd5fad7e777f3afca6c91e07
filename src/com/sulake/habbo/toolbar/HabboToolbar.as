package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1414:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_319.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this.var_16 = new ToolbarView(this._windowManager,this._assetLibrary,this.var_319.getHabboMainConnection(null),events);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "HabboAchievementShareIdMessageParser")
         {
            this.var_1414 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_16 == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_132,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1190,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_144,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1178,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1199,this.onHideWindowEvent);
         this._state = true;
