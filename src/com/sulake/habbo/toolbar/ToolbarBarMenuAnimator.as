package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_211:Boolean = true;
      
      private static const const_1279:Number = 25;
      
      private static const const_1282:Number = 90;
      
      private static const const_962:int = 50;
      
      private static const const_1331:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1429:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_767 = new Timer(const_1279);
      ...
      {
         return param1.x + param1.width < const_962 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_962 || param1.desktop.height - param1.y < const_1331;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1429.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1429.getIconLoc(param1.iconId);
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_388,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_222,this.windowEventListener);
      }
