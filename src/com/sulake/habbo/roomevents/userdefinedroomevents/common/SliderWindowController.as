package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      {
         return int(this.var_1707 * (Number(param1 - this._minValue) / (this.var_1119 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1707 * (this.var_1119 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_904)
         {
            if(param1.type == WindowMouseEvent.const_61 || param1.type == WindowMouseEvent.const_173)
            {
               this.var_904 = false;
            }
         }
         if(!this.var_904 || param1.type != WindowEvent.const_388)
         {
            return;
         }
         if(this.var_601 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_601) * this.var_601;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_601 != 0)
            {
               _loc3_ = this.var_905 + this.var_601;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_733 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_733.width,this.var_733.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_733,this.var_733.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            {
               _loc2_.bitmap = new BitmapData(this.var_734.width,this.var_734.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_734,this.var_734.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1707 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_733 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_734 = BitmapData(_loc2_.content);
      }
   }
}
