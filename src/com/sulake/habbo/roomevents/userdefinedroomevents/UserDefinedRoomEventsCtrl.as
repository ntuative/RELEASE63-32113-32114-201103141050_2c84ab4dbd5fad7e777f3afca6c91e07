package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_323:int = 3;
      
      private static var var_1312:int = 2;
      ...
      private var var_1617:TriggerConfs;
      
      private var var_1618:ActionTypes;
      
      private var var_1619:ConditionTypes;
      
      private var var_249:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_692:RoomObjectHightLighter;
      
      private var var_138:UserDefinedRoomEventsHelp;
      
      private var var_1064:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1617 = new TriggerConfs();
         this.var_1618 = new ActionTypes();
         this.var_1619 = new ConditionTypes();
         this.var_249 = new Dictionary();
         super();
         this.var_81 = param1;
         this.var_692 = new RoomObjectHightLighter(param1);
         this.var_138 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1064 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_81.assets,0,20,1);
         this.var_1064.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1064.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_692.hideAll(this.var_249);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_692.showAll(this.var_249);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1064.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_36.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_323)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1064.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_138.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1312) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1312 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_323)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1617);
         this.refreshConfigureElement(this.var_1618);
