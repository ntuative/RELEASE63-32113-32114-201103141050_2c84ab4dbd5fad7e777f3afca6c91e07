package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1044:SliderWindowController;
      ...
      {
         return ConditionCodes.var_1978;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1044.getValue());
      ...
      {
         this.var_81 = param2;
         this.var_1044 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1044.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1044.setValue(1);
         this.var_1045 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1045.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1045.setValue(50);
      }
