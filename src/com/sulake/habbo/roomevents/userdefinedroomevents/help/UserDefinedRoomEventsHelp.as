package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1841:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1841 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1184 = this.var_1841.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1184)
         {
            this.var_1184.procedure = this.onButtonClick;
         }
         this.var_1185 = this.var_1841.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1185)
         {
            this.var_1185.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_268 >= this.var_74.length - 1)
         {
            this.var_1185.disable();
         }
         else
         {
            this.var_1185.enable();
         }
         if(this.var_268 <= 0)
         {
            this.var_1184.disable();
         }
         else
         {
            this.var_1184.enable();
         }
      }
      ...
      {
         ++this.var_268;
         this.var_268 = Math.min(this.var_268,this.var_74.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_268;
         this.var_268 = Math.max(this.var_268,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_74[this.var_268][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_74[this.var_268][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_74[this.var_268][1]).value;
