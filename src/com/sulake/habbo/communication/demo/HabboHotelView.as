package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1154:Function;
      
      private var var_752:IAssetLibrary;
      
      private var var_1155:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_752.loadAssetFromFile("hotel_view_banner_" + this.var_1155,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_863));
            }
