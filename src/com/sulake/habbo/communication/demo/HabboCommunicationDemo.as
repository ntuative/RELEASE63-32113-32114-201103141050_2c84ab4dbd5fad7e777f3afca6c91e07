package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2413:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_603 = param1;
            this.var_56.initConnection(HabboConnectionType.const_254);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_101,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_56 && this.var_159 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_603 = this.var_159.getKey("sso.ticket",null);
         this.var_1717 = this.var_159.getKey("flash.client.url","");
         this.var_2411 = this.var_159.getKey("external.variables.txt","");
         if(this.var_219 == null)
         {
            this.var_219 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_56.mode = HabboConnectionType.const_90;
            if(this.var_603)
            {
               this.var_56.initConnection(HabboConnectionType.const_254);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_16.addEventListener(HabboLoginDemoView.const_512,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1158;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_254);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_824);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2413 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_90:
               ...
               this.var_1369 = _loc4_;
               this.var_219.loadBannerImage(_loc7_ + "?token=" + this.var_1369,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1158:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1463:
               this.var_909 = this.generateRandomHexString(30);
               this.var_496 = new DiffieHellman(new BigInteger(this.var_159.getKey("connection.development.prime"),16),new BigInteger(this.var_159.getKey("connection.development.generator"),16));
               this.var_496.init(this.var_909);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:String = this.var_496.method_8(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2413);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1368 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_273);
         connection.send(new VersionCheckMessageComposer(401,this.var_1717,this.var_2411));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1710,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1368)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_181);
         }
         if(param1.type == Event.CLOSE && !this.var_2412)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1369);
