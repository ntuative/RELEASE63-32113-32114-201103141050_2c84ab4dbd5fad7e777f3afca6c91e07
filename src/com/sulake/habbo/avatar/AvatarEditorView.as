package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1250:IWindowContainer;
      
      public static var var_1514:IWindowContainer;
      
      public static var var_1997:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1205 = [];
         this.var_1451 = [AvatarEditorFigureCategory.const_746,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_248,AvatarEditorFigureCategory.const_740,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_110];
         super();
         ...
         if(var_1250 == null)
         {
            ...
            var_1250 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1514 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1514 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_433 = new Timer(1000);
         this.var_433.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1451;
         }
         for each(_loc6_ in param4)
         {
            this.var_1205.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_433.stop();
            this.var_433.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_433 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1451);
         }
         if(param1.length != this.var_1205.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1205.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2636 = this.canChangeOutfit();
            this.var_433.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_516 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_516.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_516.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1205.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_516.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_516.numSelectables)
               {
                  this.var_516.getSelectableAt(_loc6_).x = this.var_516.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1451;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_42) && (this.var_1879 == AvatarEditorSideCategory.const_110 || this.var_2637))
         {
         ...
         this.setViewToCategory(this.var_365);
      }
      ...
      {
         if(this.var_1879 == AvatarEditorSideCategory.const_110)
         {
            this.var_2637 = false;
            this.setSideContent(AvatarEditorSideCategory.const_737);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_737:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_365 = param1;
         this.var_516.setSelected(this.var_516.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_515)
         {
            ...
            this.var_515 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_515.procedure = this.stripClubDialogEventProc;
            this.var_515.center();
         }
         else
         {
