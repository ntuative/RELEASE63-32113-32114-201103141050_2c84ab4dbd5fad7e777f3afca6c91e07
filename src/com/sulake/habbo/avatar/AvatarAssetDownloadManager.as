package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_1987:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_915 = new Timer(this.const_1987,1);
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_914);
            if(this.var_1374.indexOf("?") > 0)
            {
               _loc2_ = this.var_1374 + "&retry=" + this.var_914;
            }
            else
            {
               _loc2_ = this.var_1374 + "?retry=" + this.var_914;
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2440,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1741)
         {
            this.var_1133.push([param1,param2]);
            return;
         }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_913)
         {
            _loc7_ = true;
            _loc4_ = this.var_913[_loc3_];
      ...
      {
         var _loc1_:* = null;
         while(this.var_740.length > 0 && this.var_741.length < this.const_1663)
         {
