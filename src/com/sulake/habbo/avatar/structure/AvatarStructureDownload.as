package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1155:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2728:IStructureData;
      
      private var var_1939:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1939 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2728.appendXML(this.var_1939);
         dispatchEvent(new Event(AvatarStructureDownload.const_1155));
      }
   }
}
