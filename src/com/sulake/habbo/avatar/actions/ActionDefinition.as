package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1810:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2570 = parseInt(param1.@precedence);
         this.var_2565 = String(param1.@activepartset);
         this.var_2566 = String(param1.@assetpartdefinition);
         this.var_2564 = String(param1.@lay);
         this.var_705 = String(param1.@geometrytype);
         this.var_2568 = Boolean(parseInt(param1.@main));
         this.var_2569 = Boolean(parseInt(param1.@method_8));
         this.var_2563 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "HabboAchievementShareIdMessageParser"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2567 = _loc6_;
            }
            else
            {
               this.var_1810[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1810[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2567;
         }
         return _loc2_;
      }
