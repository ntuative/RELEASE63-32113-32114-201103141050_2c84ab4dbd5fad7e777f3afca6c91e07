package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1235:String = "Default";
      
      private static const const_1236:int = 2;
      
      private static const const_1237:String = AvatarSetType.const_36;
      ...
      protected var var_252:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_542:IAvatarDataContainer;
      
      protected var var_325:Array;
      
      protected var var_45:BitmapData;
      
      private var var_837:IActiveActionData;
      ...
      protected var var_1269:Boolean = false;
      ...
      private var var_2679:String = null;
      
      private var var_2677:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_252 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1237,const_1236);
         this.var_325 = new Array();
         this.var_837 = new ActiveActionData(AvatarAction.const_344);
         this.var_837.definition = this._structure.getActionDefinition(const_1235);
         this.resetActions();
      ...
      {
         param2 += this.var_1535;
         if(param2 < AvatarDirectionAngle.const_1052)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_646,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_276.length == 1 && this.var_89 == this.var_1822)
         {
            return this.var_89 + this.var_524 + this.var_646 % 4;
         }
         if(this.var_276.length == 2)
         {
            for each(_loc1_ in this.var_276)
            {
               ...
               {
                  _loc2_ = this.var_646 % 11;
                  return this.var_89 + "_" + this.var_1822 + this.var_524 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2678 || param2 != this.var_2679 || param1 != this.var_2677)
         {
            this.var_2678 = param3;
            this.var_2679 = param2;
            this.var_2677 = param1;
            this.var_1904 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1269 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1269)
            {
               this.var_45.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_282.definition.geometryType,this.var_89);
         this.var_45.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_646);
         ...
         {
            if(this.var_542.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_542.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_282.definition.geometryType,this.var_89);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_646);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_325.length)
         {
            _loc3_ = this.var_325[_loc4_];
         ...
         this.var_325.push(new ActiveActionData(param1,param2,this.var_646));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_282 = this.var_837;
         this.var_282.definition = this.var_837.definition;
         this.resetBodyPartCache(this.var_837);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_524 = "";
         this.var_276 = this._structure.sortActions(this.var_325);
         if(this.var_276 == null)
         {
         ...
         {
            this.var_761 = this._structure.getCanvasOffsets(this.var_276,this._scale,this.var_89);
            for each(_loc4_ in this.var_276)
            {
               this.var_524 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_276)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1474 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1475 != this.var_524)
            {
               _loc1_ = true;
               this.var_1475 = this.var_524;
            }
         }
         this.var_1287 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_276)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_836 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1535 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_542 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_278 || _loc1_.actionType == AvatarAction.const_246 || _loc1_.actionType == AvatarAction.const_379)
               {
                  this.var_836 = true;
               }
            }
