package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_1422:IAvatarImage;
      ...
      private var var_402:AvatarImageBodyPartContainer;
      ...
      private var var_2274:ByteArray;
      
      private var var_2275:ImageData;
      
      private var var_903:PaletteMap;
      
      private var var_869:Array;
      
      private var var_870:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_705 == GeometryType.const_1037 && param1 == GeometryType.const_1102 || this.var_705 == GeometryType.const_1102 && param1 == GeometryType.const_1037)
         {
            this.var_705 = param1;
            this.var_86 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_348.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_894)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_546)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1422.getFigure(),_loc5_,this.var_705,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_402 = _loc10_.getImageContainer(_loc4_);
         if(this.var_402 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_402 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_348);
            if(this.var_402 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_402,_loc4_);
         }
         this.var_402.offset = _loc8_;
         return this.var_402;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_86)
         {
            this.var_86 = this._structure.getCanvas(this._scale,this.var_705);
            if(!this.var_86)
            {
               return null;
            }
            this.var_2273 = new Point(0,this.var_86.height - int(this.var_86.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1578[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_762 || _loc10_ == AvatarAction.const_379;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1326 = this.var_110.bodyPartId;
               this.var_180 = this.var_110.partType;
               this.var_1647 = this.var_110.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_110.flippedPartType != this.var_180)
                     {
                        this.var_180 = this.var_110.flippedPartType;
                     }
                  }
               }
               this.var_1325 = this._scale + "_" + this.var_110.action.assetPartDefinition + "_" + this.var_180 + "_" + this.var_1647 + "_" + _loc5_ + "_" + this._frame;
               this.var_409 = this._assets.getAssetByName(this.var_1325) as BitmapDataAsset;
               if(this.var_409 == null)
               {
                  this.var_1325 = this._scale + "_std_" + this.var_180 + "_" + this.var_1647 + "_" + _loc5_ + "_0";
                  this.var_409 = this._assets.getAssetByName(this.var_1325) as BitmapDataAsset;
               }
               if(!(!this.var_409 || !this.var_409.content))
               {
                  if(this.var_110.paletteMapId > -1)
                  {
                     this.var_903 = this._structure.renderManager.paletteManager.getPalette(this.var_110.paletteMapId);
                     if(this.var_903 != null)
                     {
                        this.var_871 = this.var_409.content as BitmapData;
                        this.var_181 = new BitmapData(this.var_871.width,this.var_871.height);
                        this.var_2274 = this.var_903.colorize(this.var_871.getPixels(this.var_871.rect));
                        this.var_181.setPixels(this.var_181.rect,this.var_2274);
                     }
                     else
                     {
                        this.var_181 = (this.var_409.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1326 == AvatarBodyPartType.const_248 || this.var_1326 == AvatarBodyPartType.const_1470 || this.var_1326 == AvatarBodyPartType.const_1469) && this.var_110.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_181.colorTransform(this.var_181.rect,this.var_110.color.colorTransform);
                  }
                  if(this.var_110.isBlendable)
                  {
                     this.var_181.colorTransform(this.var_181.rect,this.var_110.blendTransform);
                  }
                  this.var_870 = this.var_409.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2275 = new ImageData(this.var_181,this.var_870,_loc7_);
                  this.var_869.push(this.var_2275);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2273.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_57)
            {
