package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_748:IFigurePartSet;
      ...
      private const const_1989:int = 13421772;
      
      private const const_1990:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_663 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1754 = Math.max(this.var_1754,_loc6_.colorLayerIndex);
            }
         }
         this.var_423 = this.var_67.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_663 != null && !this.var_1755)
            {
               _loc3_ = this.var_663;
            }
            else
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_331[_loc6_] + "_" + FigureData.const_153;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_608 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1753)
               {
                  ...
                  this.var_1753 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1755 && _loc2_.colorLayerIndex > 0)
               {
