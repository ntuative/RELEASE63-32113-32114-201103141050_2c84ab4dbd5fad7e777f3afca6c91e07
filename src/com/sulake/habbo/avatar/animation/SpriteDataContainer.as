package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2327:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2328 = String(param2.@member);
         this.var_2326 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1339 = [];
         this.var_1338 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1339[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1338[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1339.length)
         {
      ...
      {
         if(param1 < this.var_1338.length)
         {
            return this.var_1338[param1];
         }
         return 0;
      }
