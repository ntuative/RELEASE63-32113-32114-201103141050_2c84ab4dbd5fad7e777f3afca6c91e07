package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1888 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2660 = parseInt(_loc2_,16);
         this.var_2659 = parseInt(_loc3_,16);
         ...
         this.var_1569 = new ColorTransform(this.var_1595,this.var_1596,this.var_1593,this._alphaMultiplier);
         this.var_1210 = this.generatePaletteMapForGrayscale(this.var_2659,this.var_2660);
      }
