package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_252:AvatarImageCache;
      ...
      private var var_542:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1285);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_646);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_646);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_646);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_646);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
         ...
         switch(param1)
         {
            case AvatarAction.const_358:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1448:
                  case AvatarAction.const_1486:
                  case AvatarAction.const_1535:
                  case AvatarAction.const_1062:
                  case AvatarAction.const_1078:
                  case AvatarAction.const_1572:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_325.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_837);
         this.getCache().resetBodyPartCache(this.var_837);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1286 = this._structure.sortActions(this.var_325);
         ...
         {
            this.var_761 = this._structure.getCanvasOffsets(this.var_1286,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1286)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_379)
               {
                  this.var_836 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_246)
               {
                  this.var_836 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1201 = _loc4_.id;
                     this.var_1534 = _loc4_.breed;
                     break;
                  }
               }
            }
