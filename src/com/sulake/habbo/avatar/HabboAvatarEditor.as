package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1327:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1325:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1179:AvatarEditorHandler;
      ...
      private var var_942:IFigureData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_98 != null)
         {
            for each(_loc1_ in this.var_98)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_189)
         {
            ...
            this.var_622["null"] = new FigureData(this);
            _loc2_ = this.var_622["null"];
            _loc3_ = this.var_622["null"];
            _loc2_.loadAvatarData(const_1327,FigureData.const_78);
            _loc3_.loadAvatarData(const_1325,FigureData.FEMALE);
            this.var_98 = new Map();
            this.var_507 = new Map();
            this.var_98.add(AvatarEditorFigureCategory.const_746,new BodyModel(this));
            this.var_98.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_98.add(AvatarEditorFigureCategory.const_248,new TorsoModel(this));
            this.var_98.add(AvatarEditorFigureCategory.const_740,new LegsModel(this));
            if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
            {
               this.var_98.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            }
            this.var_507.add(AvatarEditorSideCategory.const_110,new WardrobeModel(this));
            this.var_507.add(AvatarEditorSideCategory.const_509,new ClubPromoModel(this));
            this.var_189 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_622[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_98)
         {
            for each(_loc5_ in this.var_98)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_942.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_942.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_267 == null)
            {
               this.var_267 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_267.addChild(this.var_16.window);
               if(param5)
               {
                  this.var_267.center();
               }
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_746);
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_98.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_507.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_508 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_942 = this.var_508.getFigureData(AvatarType.const_121);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1179 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_622[this.var_936];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1423 != null)
         {
            ...
            this.var_1423.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1828;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1180 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1326)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1514.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_508.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_508.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1250.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1474)
               {
                  _loc23_ = true;
               }
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1250.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_507.getValue(AvatarEditorSideCategory.const_110);
      }
