package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2015:String = "hd-99999-99999";
      ...
      private var var_1947:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_653 = RenderMode.const_1616;
         ...
         this.var_103.add(AvatarType.const_121,_loc4_);
         ...
         this.var_103.add(AvatarType.const_67,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_317.init();
         this.var_801.init();
         _loc2_ = this.var_103.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_103.getValue(AvatarType.const_67) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_103.getValue(AvatarType.const_121) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1155,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_928)
         {
            if(this.var_2741 && this.var_2740 && this.var_2739)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_103.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1947)
         {
            this.var_1947 = new AvatarFigureContainer(this.const_2015);
         }
         this.var_230.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1947,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         ...
         var _loc8_:AvatarStructure = this.var_103.getValue(AvatarType.const_67) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_103.getValue(AvatarType.const_67);
      ...
      {
         var _loc3_:AvatarStructure = this.var_103.getValue(AvatarType.const_121) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_67:
               _loc3_ = this.var_103.getValue(AvatarType.const_67) as AvatarStructure;
               break;
            default:
