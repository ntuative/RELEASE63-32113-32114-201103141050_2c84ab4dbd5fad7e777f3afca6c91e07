package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1919)
         {
            this.gotoRoom(this.var_2714,this.var_2712,this.var_1920);
            this.var_1919 = false;
            this.var_1920 = "";
         }
      }
      ...
      public function startSession(param1:IRoomSession) : Boolean
      {
         ...
         {
            this.var_1481 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_92,param1));
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1024:
                  break;
               case RoomSessionHandler.const_1219:
                  break;
               case RoomSessionHandler.const_805:
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_101,_loc4_));
            _loc4_.dispose();
         }
      }
