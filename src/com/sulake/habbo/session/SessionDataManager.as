package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_555:ProductDataParser;
      ...
      private var var_285:FurnitureDataParser;
      
      private var var_1557:UserTagManager;
      
      private var var_1294:BadgeImageManager;
      
      private var var_1042:HabboGroupInfoManager;
      
      private var var_848:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_848 = new IgnoredUsersManager(this);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_285)
         {
            this.var_285.removeEventListener(FurnitureDataParser.const_116,this.onFurnitureReady);
            this.var_285.dispose();
            this.var_285 = null;
         }
         if(this.var_555)
         {
            this.var_555.removeEventListener(ProductDataParser.const_116,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1294 = new BadgeImageManager(context.root.assets,events,this.var_179,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_848.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_285)
         {
            ...
            this.var_285 = new FurnitureDataParser(this.var_470,this._wallItems,this.var_469,this._localization);
            this.var_285.addEventListener(FurnitureDataParser.const_116,this.onFurnitureReady);
            if(this.var_179.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_179.getKey("furnidata.load.url");
               this.var_285.loadData(_loc3_);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(this.var_285)
         {
            this.var_285.localization = this._localization;
            this.var_285.registerFurnitureLocalizations();
         }
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2122 = _loc2_.clubLevel;
         this.var_1555 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2516 = _loc3_.respectTotal;
         this.var_1041 = _loc3_.respectLeft;
         this.var_675 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_936 = _loc3_.sex;
         this.var_1804 = _loc3_.realName;
         this.var_2123 = _loc3_.identityId;
         this.var_848.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_936));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2124 = _loc2_.isOpen;
         this.var_2121 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1555 >= SecurityLevelEnum.const_1170;
      }
      ...
      {
         return this.var_1294.getBadgeImage(param1);
      }
      ...
      {
         return this.var_1294.getBadgeImage(param1,BadgeImageManager.const_1066);
      }
      ...
      {
         return this.var_848.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_848.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_848.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1041 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1041 = this.var_1041 - 1;
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_469.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_555 == null)
         {
            ...
            this.var_555 = new ProductDataParser(_loc2_,this.var_1191);
            this.var_555.addEventListener(ProductDataParser.const_116,this.onProductsReady);
         }
         return false;
      }
