package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2016:int = 2500;
      ...
      public function start() : Boolean
      {
         ...
         {
            this._state = RoomSessionEvent.const_92;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1497));
         this.var_1496.add(this.var_1497,getTimer());
         ++this.var_1497;
      }
      ...
      public function receivedChatWithTrackingId(param1:int) : void
      {
         ...
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2016)
            {
