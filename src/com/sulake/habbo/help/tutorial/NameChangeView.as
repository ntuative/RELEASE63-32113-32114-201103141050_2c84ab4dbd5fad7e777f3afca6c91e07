package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1581:uint = 11129827;
      ...
      private var var_1053:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1579 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_475);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_815:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_812:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1010 || param1 == ChangeUserNameResultMessageEvent.var_1009)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1053 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1053.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_475 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_475 != _loc5_)
               {
                  this.var_1580 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_475);
               break;
