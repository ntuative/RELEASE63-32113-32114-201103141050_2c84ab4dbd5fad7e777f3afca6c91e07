package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_365 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103141044));
         this.var_187 = param5;
         this.var_116 = new Map();
         this.var_116.add(HabboHelpViewEnum.const_1611,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_178,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_474,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_283,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_247,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_339,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_735,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_229,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_116.add(HabboHelpViewEnum.const_1022,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_116.add(HabboHelpViewEnum.const_1144,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_647,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_511.length == 0 || param1 != this.var_365)
            {
               this.var_511.push(this.var_365);
            }
         }
         this.var_365 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_365);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_229:
               ...
               break;
            case CallForHelpResultEnum.const_1163:
               this.showUI(HabboHelpViewEnum.const_1144);
               break;
            case CallForHelpResultEnum.const_1041:
               this.showUI(HabboHelpViewEnum.const_1022);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_116.getValue(HabboHelpViewEnum.const_178) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_519));
      }
      ...
      {
         return this.var_116.getValue(this.var_365);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2331 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2333;
         this._window.width = _loc1_.width + this.var_2331;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_511.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_365 == HabboHelpViewEnum.const_178)
         {
            return;
         }
         if(this.var_632.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_632.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_632.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_364.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_632[1],this.var_632[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_632[0],this.var_632[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_365 == HabboHelpViewEnum.const_178 || this.var_511.length == 0)
         {
            return;
         }
         if(this.var_364 == null)
         {
            ...
            this.var_364 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_364.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_364.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_364 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_364 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_364 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
