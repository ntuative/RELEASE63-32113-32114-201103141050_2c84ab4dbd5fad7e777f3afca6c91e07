package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_373:ICatalogNavigator;
      
      private var var_102:Purse;
      
      private var var_93:RecyclerLogic;
      
      private var var_136:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_225:PurchaseConfirmationDialog;
      
      private var var_312:ChargeConfirmationDialog;
      ...
      private var var_2682:Boolean = true;
      
      private var var_1905:Boolean = false;
      
      private var var_2681:GiftWrappingConfiguration;
      
      private var var_1224:ClubGiftController;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_373.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_179.getKey("client.credits.embed.enabled","false") == "HabboAchievementShareIdMessageParser";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_290.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_290.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_81)
         {
            _loc3_ = this.var_290.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_788.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_102.getActivityPointsForType(Purse.const_182)));
         var _loc1_:int = 0;
      ...
      {
         this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_723)
         {
            if(!this.var_290.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_187 != null && _loc2_)
         {
            this.var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_311.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_373 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_311 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_311.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_243,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_92:
               this.var_1905 = param1.session.isPrivateRoom;
               if(this.var_93 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_136 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1224 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_373.buildCatalogIndex(_loc2_);
         if(this.var_787 && this.var_787 != "")
         {
            this.var_373.openPage(this.var_787);
            this.var_787 = "";
            this.var_977 = -1;
         }
         else if(this.var_977 > -1)
         {
            this.var_373.openPageById(this.var_977,this.var_1906);
            this.var_977 = -1;
            this.var_1906 = -1;
            this.var_787 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_311.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_311 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_311.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2680 && this.var_517 != null)
         {
            this.var_517.playSound(HabboSoundTypesEnum.const_1046);
         }
         this.var_2680 = false;
         if(this.var_312 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2682 && this.var_517 != null)
         {
            this.var_517.playSound(HabboSoundTypesEnum.const_990);
         }
         this.var_2682 = false;
         if(this.var_312 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1224.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_311.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_136 != null)
         {
            this.var_136.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_136 != null)
         {
            this.var_136.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_136 != null)
         {
            this.var_136.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2681 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_136.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_312 == null)
         {
            this.var_312 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_312.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_788.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_788.add(_loc2_.productCode,_loc3_.slice());
            this.var_311.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "HabboAchievementShareIdMessageParser" == this.var_179.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
