package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1976:int = 10;
      ...
      private const const_1707:uint = 4.294967295E9;
      
      private const const_1975:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1632 = _loc1_.stuffTypes;
            this.var_696 = _loc1_.boxTypes;
            this.var_695 = _loc1_.ribbonTypes;
            this.var_1067 = this.var_1632[0];
            this.var_346 = this.var_696[0];
            this.var_345 = this.var_695[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_345 < 0)
         {
            this.var_345 = this.var_695.length - 1;
         }
         if(this.var_345 > this.var_695.length - 1)
         {
            this.var_345 = 0;
         }
         if(this.var_346 < 0)
         {
            this.var_346 = this.var_696.length - 1;
         }
         if(this.var_346 > this.var_696.length - 1)
         {
            this.var_346 = 0;
         }
         var _loc1_:int = this.var_696[this.var_346] * 1000 + this.var_695[this.var_345];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1067,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1319 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1632;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1067);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_696[this.var_346]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_695[this.var_345]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_92,this.var_1320,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_92.offerId,this.var_1320);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_103:
               ...
               if(this.var_2244 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_232)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1976)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2244 = _loc3_.text;
               break;
            case WindowMouseEvent.const_46:
               ...
               break;
            case WindowKeyboardEvent.const_341:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_344 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_344 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_344) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_251 == null || this.var_576 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_344) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_344);
         }
         this.var_344 = param1;
         if(this.var_344 < 0)
         {
            this.var_344 = _loc2_.numListItems - 1;
         }
         if(this.var_344 >= _loc2_.numListItems)
         {
            this.var_344 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_344) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1975;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1708) : uint(this.const_1707);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1067;
               }
            }
            _loc4_++;
         }
