package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_961:String = "bg";
      ...
      {
         this.var_16.getChildByName(const_961).style = HabboWindowStyle.const_32;
      }
      
      public function deActivate() : void
      {
         this.var_16.getChildByName(const_961).style = 3;
      }
