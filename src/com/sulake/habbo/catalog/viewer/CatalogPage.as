package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1682:String = "ctlg_";
      ...
      private var var_472:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1049:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_472 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_1682 + param1;
         ...
         this.var_2014 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2014) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1479:
               if(this.var_1049 == null)
               {
                  this.var_1049 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1049);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1634:
               ...
               break;
            case CatalogWidgetEnum.const_1449:
            ...
            case CatalogWidgetEnum.const_1389:
               ...
               break;
            case CatalogWidgetEnum.const_1453:
            ...
            case CatalogWidgetEnum.const_1426:
               ...
               break;
            case CatalogWidgetEnum.const_1391:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_472.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_472 != null)
         {
            return this.var_472.dispatchEvent(param1);
         }
         return false;
      }
   }
