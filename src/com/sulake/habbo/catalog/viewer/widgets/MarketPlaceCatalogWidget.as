package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2018:int = 40;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_532)
         {
            this.var_532.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_532 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_656)
         {
            ...
            this.var_656 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_656)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1699,_loc2_.length);
         if(!this.var_532)
         {
            this.var_532 = new Timer(25);
            this.var_532.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1247 = 0;
         this.populateList();
         this.var_532.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_656 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_656.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1698);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_103)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2019;
                  break;
               case "search_input":
                  _loc8_ = this.const_2018;
                  break;
               default:
                  return;
            }
