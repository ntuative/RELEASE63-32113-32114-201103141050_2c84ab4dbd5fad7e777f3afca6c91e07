package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1241:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_466 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_466 < 8)
         {
            return false;
         }
         this.var_2094 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_203 != null && this.var_203.length > 0)
         {
            this.var_335 = this.var_203[0];
         }
         else
         {
            this.var_335 = -1;
         }
         this._offers.add(this.var_466,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_203 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1241 && _loc2_ < this.var_203.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_466,this.var_203[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_203 != null && this.var_203.length > 0)
         {
            ...
            this.var_335 = this.var_203[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_466,this.var_335),this.getRaceLocalizationKey(this.var_466,this.var_335));
            }
         }
         return this.getRaceLocalizationKey(this.var_466,this.var_335);
      }
      ...
      {
         if(param1.productCode == this.var_2094)
         {
      ...
      private function parseSellableBreeds(param1:Array) : Array
      {
         ...
         {
            if(_loc3_.type == this.var_466 && _loc3_.sellable)
            {
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_335 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_466;
         var _loc3_:int = this.var_335;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_335 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
