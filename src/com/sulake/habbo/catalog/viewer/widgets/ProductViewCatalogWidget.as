package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1465:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_968 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1211 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1891 = new Point(this.var_88.x,this.var_88.y);
         this.var_522 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1465 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1892 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_968.text = _loc4_;
         this.var_1211.text = _loc5_;
         this.var_968.height = this.var_968.textHeight + 5;
         this.var_1211.y = this.var_968.y + this.var_968.height;
         this.var_1211.height = Math.max(130,this.var_1211.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_449:
                  _loc6_ = this.var_1892.clone();
                  if(this.var_522 != null)
                  {
                     this.var_522.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_522,this.var_1465,this.var_1922);
                     ...
                     case ProductTypeEnum.const_232:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_323,AvatarAction.const_458);
                              _loc16_.appendAction(AvatarAction.const_276,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2662)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            this.var_88.x = this.var_1891.x;
            this.var_88.y = this.var_1891.y;
            if(param3 != null)
            {
