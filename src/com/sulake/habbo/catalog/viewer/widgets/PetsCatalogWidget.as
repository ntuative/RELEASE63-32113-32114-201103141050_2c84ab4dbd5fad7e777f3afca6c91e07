package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_466 = this.getPetTypeIndexFromProduct(_loc3_.localizationId);
         if(this.var_466 >= 8)
         {
            return false;
         }
         this.updateAvailableBreeds(_loc3_.localizationId);
         this.var_2094 = _loc3_.localizationId;
         this.var_372 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc5_ = _loc4_.avatarRenderManager.petDataManager.getPetData(this.var_466,this);
               if(_loc5_)
               {
         ...
         this._offers.add(this.var_466,_loc3_);
      ...
      private function updateBreedSelections() : void
      {
         ...
         while(_loc3_ < this.var_203.length)
         {
            ...
            _loc2_.push(_loc1_.getKey(this.getRaceLocalizationKey(this.var_466,_loc5_),this.getRaceLocalizationKey(this.var_466,_loc5_)));
            _loc3_++;
         }
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_203 == null || this.var_781 >= this.var_203.length)
         {
            return;
         }
         var _loc2_:* = 0;
         ...
         var _loc3_:int = this.var_203[this.var_781] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_466,_loc3_,_loc2_,AvatarScaleType.const_57,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_323,AvatarAction.const_786);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var breed:int = this.var_203[this.var_781] as int;
