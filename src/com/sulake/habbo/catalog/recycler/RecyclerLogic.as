package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_942:int = 2;
      ...
      {
         return this.var_604 != const_943;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1727 != RecyclerStatusMessageEvent.const_1074;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_604 == const_417;
      }
      ...
      {
         this.var_604 = const_942;
         this.var_114 = new Array(const_199);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_199)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_604 = const_943;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1666:
               this.var_604 = const_417;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1074:
               if(this.var_16 == null || this.var_16.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1482:
               if(this.var_16 == null || this.var_16.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1218:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1527:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_114.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_199)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_114.length < const_199)
         {
            return false;
         }
         var _loc1_:int = 0;
