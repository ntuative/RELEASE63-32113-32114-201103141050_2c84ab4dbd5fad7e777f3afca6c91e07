package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_578 = 0;
         for each(_loc4_ in this.var_148)
         {
         ...
         _loc3_.draw(_loc6_);
         this.var_1077 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(this.var_1077 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1077,(param2 - this.var_867) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1077 + this.var_1077 / -this.var_2821 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_867 - this.var_867 / this.var_578 * this.var_148[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_148 && this._x.length > 1;
      }
   }
}
