package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_918:uint = 11;
      ...
      private var var_1051:IHabboWindowManager;
      
      private var var_187:IHabboToolbar;
      
      private var var_138:IHabboHelp;
      ...
      private var var_561:FramerateTracker = null;
      
      private var var_247:LatencyTracker = null;
      
      private var var_560:LagWarningLogger = null;
      
      private var var_559:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_561 = new FramerateTracker();
         this.var_247 = new LatencyTracker();
         this.var_560 = new LagWarningLogger();
         this.var_559 = new ToolbarClickTracker(this);
         this.var_1301 = new Array(const_918);
         var _loc4_:int = 0;
         while(_loc4_ < const_918)
         {
            this.var_1301[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1570,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1432,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1533,Capabilities.serverString);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1051)
            {
               this.var_1051.release(new IIDHabboWindowManager());
               this.var_1051 = null;
            }
            if(this.var_296)
            {
            ...
            if(this.var_192)
            {
               if(!this.var_192.disposed)
               {
                  ...
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.const_360,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_138)
            {
               if(!this.var_138.disposed)
               {
                  this.var_138.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_138.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_138.release(new IIDHabboHelp());
               this.var_138 = null;
            }
            if(this.var_187)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_179)
         {
            if(this.var_247 != null)
            {
               this.var_247.configuration = this.var_179;
            }
            if(this.var_246 != null)
            {
               this.var_246.configuration = this.var_179;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1462);
            if(this.var_179)
            {
               if(this.var_560 != null)
               {
                  this.var_560.configure(this.var_179);
               }
               if(this.var_561 != null)
               {
                  this.var_561.configure(this.var_179);
               }
               if(this.var_559 != null)
               {
                  this.var_559.configure(this.var_179);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_824,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_273,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_863,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_560 != null)
            {
               this.var_560.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_863)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1612);
         }
         else if(param1.type == HabboHotelViewEvent.const_521)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1507);
         }
         else if(param1.type == HabboHotelViewEvent.const_68)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1410);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1522);
               break;
            case HabboCommunicationEvent.const_824:
               this.trackLoginStep(HabboLoginTrackingStep.const_1416,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_273:
               this.trackLoginStep(HabboLoginTrackingStep.const_273);
               break;
      ...
      {
         this.var_1051 = IHabboWindowManager(param2);
         if(this.var_1051)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_179)
            {
               if(this.var_179.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1301)
                  {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.const_360,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_138 = param2 as IHabboHelp;
         this.var_138.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_138.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2137)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1619);
            this.var_2137 = true;
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_296.events.addEventListener(AdEvent.const_542,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_559)
         {
            this.var_559.track(param1.iconName);
         }
      }
      ...
      {
         this.var_560.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_473 > -1 && _loc2_ < this.var_473)
         {
            ++this.var_1575;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1575);
         }
         if(this.var_473 > -1 && _loc2_ - this.var_473 > 15000)
         {
            ++this.var_1574;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1574);
         }
         this.var_473 = _loc2_;
         if(this.var_246 != null)
         {
            this.var_246.update(param1,this.var_473);
         }
         if(this.var_247 != null)
         {
            this.var_247.update(param1,this.var_473);
         }
         if(this.var_561 != null)
         {
            this.var_561.trackUpdate(param1,this,this.var_473);
         }
         if(this.var_560 != null)
         {
            this.var_560.update(this.var_473);
         }
      }
   }
}
