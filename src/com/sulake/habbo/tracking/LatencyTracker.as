package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1933 = int(this.var_179.getKey("latencytest.interval"));
         this.var_1935 = int(this.var_179.getKey("latencytest.report.index"));
         this.var_2722 = int(this.var_179.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1934 > this.var_1933)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1934 = getTimer();
         this.var_650.add(this.var_1486,this.var_1934);
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_650 == null || this.var_229 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_650.getValue(_loc2_.requestId);
         this.var_650.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_229.push(_loc4_);
         if(this.var_229.length == this.var_1935 && this.var_1935 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1932) > this.var_2722 || this.var_1932 == 0)
            {
               this.var_1932 = _loc9_;
