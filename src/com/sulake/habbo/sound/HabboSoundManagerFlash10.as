package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_862:Map;
      
      private var var_694:int;
      
      private var var_861:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1128,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_862.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_862.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_574.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_693.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_693,events);
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_860.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_860 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_179 == null || this._connection == null || this._roomEngine == null || this.var_481 != null)
         {
            return;
         }
         this.var_481 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_574.getValue(_loc2_);
         ...
         this.var_574.remove(_loc2_);
         this.var_693.add(_loc3_,_loc6_);
         if(this.var_574.length == 0 && this.var_694 != -1)
         {
            this.var_861.ready = true;
            _loc7_ = this.var_694;
            this.var_694 = -1;
            this.var_861 = null;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1128,_loc7_));
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_481.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1668,this.var_694));
         this.var_694 = -1;
         this.var_861 = null;
      }
      ...
      {
         this._volume = param1;
         this.var_481.updateVolume(this._volume);
