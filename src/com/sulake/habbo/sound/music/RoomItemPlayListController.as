package com.sulake.habbo.sound.music
{
   ...
   public class RoomItemPlayListController implements IPlayListController, IDisposable
   {
      ...
      private var var_481:HabboMusicController;
      ...
      public function RoomItemPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_807,this.method_2);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_828,this.onSoundMachinePlayEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_887,this.onSoundMachineStopEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_774,this.onJukeboxStopEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_504,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_807,this.method_2);
               this._events = null;
            }
            if(this.var_81)
            {
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_828,this.onSoundMachinePlayEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_887,this.onSoundMachineStopEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_774,this.onJukeboxStopEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_504,this.onDisposeEvent);
               this.var_81 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_487 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_481.requestSongInfo(_loc2_.id);
            }
         }
      }
      ...
      {
         this.var_481.stop(HabboMusicPrioritiesEnum.PRIORITY_ROOM_PLAYLIST);
         this.var_487 = -1;
         this.var_721 = false;
      }
      ...
      {
         var _loc2_:IHabboSound = this.var_481.getSongObject(this.var_487);
         if(_loc2_ != null)
         {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_481.playSong(param1,this.priority,_loc3_))
         {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_.current >= 0)
         {
            this.var_481.playSong(_loc3_.current,this.priority,_loc3_.syncCount / 1000);
         }
         if(_loc3_.next >= 0)
         {
            this.var_481.requestSongInfo(_loc3_.next);
         }
         this.var_721 = true;
