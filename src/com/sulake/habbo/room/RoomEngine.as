package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_1381:int = 40;
      ...
      private var var_1004:IRoomRendererFactory = null;
      ...
      private var var_807:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_807 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_489.release(new IIDRoomObjectVisualizationFactory());
            this.var_489 = null;
         }
         if(this.var_49 != null)
         {
         ...
         {
            this.var_1004.release(new IIDRoomRendererFactory());
            this.var_1004 = null;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_49 != null)
         {
            ...
            _loc2_ = this.var_49.getRoom(this.getRoomIdentifier(this.var_104,this.var_105));
      ...
      private function createRoomFurniture() : void
      {
         ...
         for each(_loc3_ in this.var_321)
         {
            _loc4_ = 0;
            _loc5_ = null;
            while((_loc5_ = _loc3_.getFurnitureData()) != null)
            {
               this.addObjectFurnitureFromData(_loc3_.roomId,_loc3_.roomCategory,_loc5_.id,_loc5_);
               if(++_loc4_ % 5 == 0)
               {
                  _loc6_ = getTimer();
                  if(_loc6_ - _loc1_ >= const_1381)
                  {
                     this.var_1966 = true;
                     break;
                  }
         ...
         while(_loc2_ < this.var_321.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_104 || _loc6_ != this.var_105 || !this.var_1240)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_694) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_789) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_681) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_616) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_489;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_49 != null)
         {
            ...
            this.var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_317);
            this.var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_76);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1004 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_813,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_813)
         {
            this.var_2756 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_296.events.addEventListener(AdEvent.const_542,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_290;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_23 != null)
         {
            ...
            {
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_227,this.method_1);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_469,this.method_1);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_569,this.method_1);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_157,this.method_1);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_897,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_149,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_148,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_129,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_143,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_ECOTRONBOX,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_140,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_109,this.method_1);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_135,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_566,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_548,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_526,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_487,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_427,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_441,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_515,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_433,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_522,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_523,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_578,this.method_1);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_499,this.method_1);
               this.var_23.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_63,this.method_1);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_511,this.method_1);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_573,this.method_1);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_301,this.method_1);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_424,this.method_1);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_356,this.method_1);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_383,this.method_1);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_544,this.method_1);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_1016,this.method_1);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_541,this.method_1);
            }
         }
      }
      ...
      {
         if(this.var_23 == null || this.var_489 == null || this.var_49 == null || this.var_1004 == null || this._communication == null || this.var_159 == null || !this.var_2756)
         {
            return;
         }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1001,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1001);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_749,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1021,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_629,1,true);
            _loc13_ = parseInt(this.var_159.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1036,_loc13_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_334,const_612,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_629,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_697,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_694,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_681,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_789,_loc18_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1031,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_838,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_717,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_836,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_437,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_224);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_618,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_888,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_618,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_888,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1101,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_979,const_1379,RoomObjectCategoryEnum.const_317);
         if(this.var_159.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_980,const_1380,RoomObjectCategoryEnum.const_317);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_334,RoomObjectCategoryEnum.const_76);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_384.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_384.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_838,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_717,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_836,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1512,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1183,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1175,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_1004.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            if(this.isPublicRoomWorldType(_loc12_))
            {
               if(this.var_13 != null)
               {
                  ...
                  {
                     _loc10_.geometry.method_9();
                  }
               }
            }
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_697);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_618);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_888);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1101);
      ...
      {
         var _loc8_:int = param2 - this.var_1506;
         var _loc9_:int = param3 - this.var_1507;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1240 = true;
               this.var_1005 = false;
               this.var_2757 = this.var_1506;
               this.var_2758 = this.var_1507;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1240)
            {
               if(!this.var_1005)
               {
                  _loc8_ = param2 - this.var_2757;
                  _loc9_ = param3 - this.var_2758;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_442,this.var_104,this.var_105,-1,RoomObjectCategoryEnum.const_170));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_79 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_334,const_612);
                     this.var_79.handleRoomObjectEvent(_loc14_,this.var_104,this.var_105);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_104,this.var_105,this.var_1505);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1506 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1507 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_104,this.var_105,this.var_1505);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_104,this.var_105,this.var_1505);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_79 != null)
         {
            return this.var_79.modifyRoomObject(this.var_104,this.var_105,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_79 != null)
         {
            ...
            {
               return this.var_79.modifyWallItemData(this.var_104,this.var_105,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_79 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_79.deleteWallItem(this.var_104,this.var_105,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_629) != 0)
         {
            return false;
         }
         if(this.var_79 != null)
         {
            return this.var_79.initializeRoomObjectInsert(this.var_104,this.var_105,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_79 != null)
         {
            this.var_79.cancelRoomObjectInsert(this.var_104,this.var_105);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_980,RoomObjectCategoryEnum.const_317);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_979,RoomObjectCategoryEnum.const_317);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc11_ != null)
         {
            _loc12_ = new FurnitureData(param3,param4,param5,param6,param7,param8,param9,param10);
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(param4 == null)
         {
            ...
            if(_loc10_ != null)
            {
               param4 = _loc10_.getFurnitureDataWithId(param3);
            }
         }
         if(param4 == null)
         {
         ...
         var _loc5_:String = this.getFurnitureType(param4.typeId);
         var _loc6_:int = this.getFurnitureColorIndex(param4.typeId);
         var _loc7_:String = this.getRoomObjectAdURL(_loc5_);
         if(_loc5_ == null)
         {
            _loc5_ = "";
         }
         var _loc8_:IRoomObjectController = this.createObjectFurniture(param1,param2,param3,_loc5_);
         if(_loc8_ == null)
         {
            return false;
         }
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_238,_loc6_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_391,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_381,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1203,1,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1063,param4.expiryTime);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1058,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_328,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         var _loc9_:ISelectedRoomObjectData = this.getPlacedObjectData(param1,param2);
         if(_loc9_ && Math.abs(_loc9_.id) == param3 && _loc9_.category == RoomObjectCategoryEnum.const_28)
         {
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_238,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_391,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_381,_loc11_,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_328,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1142) > 0)
               {
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_695,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_328,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      private function getObject(param1:String, param2:int, param3:int) : IRoomObjectController
      {
         ...
         if(_loc5_ == null && param3 == RoomObjectCategoryEnum.const_28)
         {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_818,this.var_104,this.var_105,param2,param3));
            }
         }
      }
      ...
      private function method_1(param1:RoomObjectEvent) : void
      {
         if(this.var_79 != null)
         {
            this.var_79.handleRoomObjectEvent(param1,this.var_104,this.var_105);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_558);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_193,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               ...
               _loc8_.addPlane(RoomPlaneData.const_297,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_852,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_751,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_794,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_437,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_531 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this.var_49.getRoom(const_613);
         if(_loc11_ == null)
         {
            _loc11_ = this.var_49.createRoom(const_613,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_807.reserveNumber();
         ...
         switch(_loc13_)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_558,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_627,int(param2));
               }
               break;
         ...
         {
            this.var_1239.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1049,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_807.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_104,this.var_105,const_334,RoomObjectCategoryEnum.const_76,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_49.getRoom(const_613);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1049);
               ...
               this.var_807.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1239.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_357,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1156,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1222,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1105,RoomObjectVariableEnum.const_357,param1.clickUrl);
