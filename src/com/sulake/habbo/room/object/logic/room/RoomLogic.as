package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1772:int = 255;
      
      private var var_1394:uint = 16777215;
      
      private var var_1769:int = 255;
      
      private var var_1144:uint = 16777215;
      
      private var var_1771:int = 255;
      
      private var var_1145:int = 0;
      
      private var var_1770:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_673,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_766,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_780,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1145)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1772;
            if(_loc2_ - this.var_1145 >= this.var_1770)
            {
               _loc3_ = this.var_1144;
               _loc4_ = this.var_1771;
               this.var_1145 = 0;
            }
            else
            {
               _loc7_ = this.var_1394 >> 16 & 255;
               _loc8_ = this.var_1394 >> 8 & 255;
               _loc9_ = this.var_1394 & 255;
               _loc10_ = this.var_1144 >> 16 & 255;
               _loc11_ = this.var_1144 >> 8 & 255;
               _loc12_ = this.var_1144 & 255;
               _loc13_ = (_loc2_ - this.var_1145) / this.var_1770;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1769 + (this.var_1771 - this.var_1769) * _loc13_;
               this._color = _loc3_;
               this.var_1772 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_838:
               param2.setString(RoomObjectVariableEnum.const_852,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_717:
               param2.setString(RoomObjectVariableEnum.const_751,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_836:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_437:
               ...
               this.var_476.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_695:
               _loc4_ = this.var_476.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_476.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1008,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1175:
               param2.setNumber(RoomObjectVariableEnum.const_673,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1183:
               param2.setNumber(RoomObjectVariableEnum.const_766,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_780,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1394 = this._color;
         this.var_1769 = this.var_1772;
         this.var_1144 = _loc3_;
         this.var_1771 = _loc4_;
         this.var_1145 = getTimer();
         this.var_1770 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_570,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1396,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1412,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1384,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_570,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_167 || _loc13_ == RoomPlaneData.const_297)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
