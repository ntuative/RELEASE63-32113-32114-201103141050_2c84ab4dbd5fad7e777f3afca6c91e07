package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      private static const const_953:Number = 1.5;
      
      private static const const_955:int = 28;
      
      private static const const_954:int = 29;
      
      private static const const_952:int = 500;
      
      private static const const_1310:int = 999999999;
      ...
      {
         super();
         this.var_1795 = getTimer() + this.getBlinkInterval();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarPostureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_905,_loc3_.parameter);
            return;
         }
         ...
         if(param1 is RoomObjectAvatarWaveUpdateMessage)
         {
            ...
            if(_loc8_.isWaving)
            {
               _loc2_.setNumber(RoomObjectVariableEnum.const_377,1);
               this.var_1162 = getTimer() + 0;
            }
            else
            {
               _loc2_.setNumber(RoomObjectVariableEnum.const_377,0);
               this.var_1162 = 0;
            }
            return;
         }
         if(param1 is RoomObjectAvatarDanceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1011,_loc9_.danceStyle);
            return;
         }
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarSleepUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_335,Number(_loc10_.isSleeping));
            return;
         }
         if(param1 is RoomObjectAvatarPlayerValueUpdateMessage)
         {
            _loc11_ = param1 as RoomObjectAvatarPlayerValueUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_692,_loc11_.value);
         ...
         if(param1 is RoomObjectAvatarCarryObjectUpdateMessage)
         {
            ...
            if(_loc15_.itemType < const_1310)
            {
         ...
         if(param1 is RoomObjectAvatarUseObjectUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_392,_loc16_.itemType);
            return;
         }
         if(param1 is RoomObjectAvatarSignUpdateMessage)
         {
            _loc17_ = param1 as RoomObjectAvatarSignUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_1148,_loc17_.signType);
            this.var_1409 = getTimer() + 5000;
            return;
         }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1107,_loc22_);
            return;
         }
         if(param1 is RoomObjectAvatarSelectedMessage)
         {
            _loc23_ = param1 as RoomObjectAvatarSelectedMessage;
            this.var_207 = _loc23_.selected;
            this.var_486 = null;
            return;
         }
      }
      ...
      private function updateEffect(param1:int, param2:int, param3:IRoomObjectModelController) : void
      {
         if(param1 == const_955)
         {
            this.var_755 = getTimer() + const_952;
            this.var_1408 = const_954;
         }
         else if(param3.getNumber(RoomObjectVariableEnum.const_524) == const_954)
         {
            this.var_755 = getTimer() + const_952;
         ...
         param3.setNumber(RoomObjectVariableEnum.const_524,param1);
      }
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         if(this.var_1336 > 0)
         {
            ...
            else if(this.var_933 == 0 && this.var_754 == 0)
            {
               this.var_754 = param1 + this.getTalkingPauseInterval();
               this.var_933 = this.var_754 + this.getTalkingPauseLength();
            }
         ...
         if(this.var_1409 > 0 && param1 > this.var_1409)
         {
            param2.setNumber(RoomObjectVariableEnum.const_1148,0);
            this.var_1409 = 0;
         }
         if(this.var_934 > 0)
         {
            ...
            else if((this.var_934 - param1) % 10000 < 1000 && this.var_1796)
            {
               param2.setNumber(RoomObjectVariableEnum.const_392,1);
            }
            else
            {
         ...
         if(param1 > this.var_1795)
         {
            param2.setNumber(RoomObjectVariableEnum.const_806,1);
            this.var_1795 = param1 + this.getBlinkInterval();
            this.var_1407 = param1 + this.getBlinkLength();
         }
         if(this.var_1407 > 0 && param1 > this.var_1407)
         {
         ...
         {
            param2.setNumber(RoomObjectVariableEnum.const_524,this.var_1408);
            this.var_755 = 0;
         }
      ...
      private function targetIsWarping(param1:IVector3d) : Boolean
      {
         ...
         if(Math.abs(_loc2_.x - param1.x) > const_953 || Math.abs(_loc2_.y - param1.y) > const_953)
         {
            return true;
         }
         return false;
