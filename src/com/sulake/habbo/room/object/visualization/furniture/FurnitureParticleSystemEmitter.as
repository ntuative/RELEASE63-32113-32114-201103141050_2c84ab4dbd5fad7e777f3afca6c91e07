package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1434:String = "cone";
      
      public static const const_1517:String = "plane";
      
      public static const const_1428:String = "sphere";
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_235 = param6;
         this.var_2044 = param7;
         this.var_2045 = param9;
         this._energy = param8;
      ...
      public function reset() : void
      {
         ...
         this.var_829 = 0;
         this.var_918 = false;
         this.init(0,0,0,this._direction,this.var_2043,this.var_830,this.var_2045,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2046)
         {
            switch(this.var_2044)
            {
               case const_1434:
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_829 < this.var_1273)
         {
            if(this.age % this.var_2048 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_829 < this.var_1273)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_235) * this.x - (1 - this.var_235) * this.lastX;
            this.y = (2 - this.var_235) * this.y - (1 - this.var_235) * this.lastY + this.var_1524 * this.var_830 * this.var_830;
            this.z = (2 - this.var_235) * this.z - (1 - this.var_235) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_329)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_235) * _loc2_.x - (1 - this.var_235) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_235) * _loc2_.y - (1 - this.var_235) * _loc2_.lastY + this.var_1524 * this.var_830 * this.var_830;
            _loc2_.z = (2 - this.var_235) * _loc2_.z - (1 - this.var_235) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_329.splice(this.var_329.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
