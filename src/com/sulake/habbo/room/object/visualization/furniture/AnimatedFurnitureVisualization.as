   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_956,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_956,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_117 != null)
         {
            this.var_117.setLayerCount(this.var_593);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_956 = param1;
            this.var_593 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:* = null;
         if(!this.var_117.animationOver || this.var_957)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         var _loc10_:* = null;
         var _loc11_:int = 0;
         if(param1.animationOver && !this.var_957)
         {
            return null;
         }
         ...
         var _loc7_:int = this.var_593 - 1;
         while(_loc7_ >= 0)
         {
            _loc8_ = param1.getAnimationPlayed(_loc7_);
            if(!_loc8_ || this.var_957)
            {
               ...
               if(this.var_957 || _loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  _loc11_ = 0;
                  if(_loc10_ != null)
                  {
                  ...
                  if(_loc11_ == AnimationFrame.const_1010)
                  {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_439)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
