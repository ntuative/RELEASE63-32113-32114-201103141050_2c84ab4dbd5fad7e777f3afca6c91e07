package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_211:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_211 = this.var_556[param1];
               _loc3_ = true;
            }
            else if(param1 != var_97)
            {
               if(this.var_211)
               {
                  this.var_211.reset();
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_211)
         {
            this.var_211.setAnimation(param1);
         }
      ...
      {
         if(this.var_211 && this.var_211.controlsSprite(param3))
         {
            return this.var_211.getSpriteYOffset(param1,param2,param3);
         }
