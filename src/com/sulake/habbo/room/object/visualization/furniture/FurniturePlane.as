package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_784:Vector3d = null;
      ...
      {
         if(param1 != this.var_2676)
         {
            if(!param1)
            {
               this.var_309.assign(this.var_783);
               this.var_310.assign(this.var_784);
            }
            else
            {
               this.var_309.assign(this.var_783);
               this.var_309.mul(this.var_784.length / this.var_783.length);
               this.var_310.assign(this.var_784);
               this.var_310.mul(this.var_783.length / this.var_784.length);
            }
            this.var_1902 = -1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_309.length * param1.scale);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_80 == null && this.var_1207 != null || this.var_309 == null || this.var_310 == null || this.var_639 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1902)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1471 || _loc4_.y != this.var_2158 || _loc4_.z != this.var_2157 || param1.scale != this.var_2152))
            {
               this.var_1471 = _loc4_.x;
               this.var_2158 = _loc4_.y;
               this.var_2157 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1207);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_166.z - _loc7_,this.var_119.z - _loc7_,this.var_87.z - _loc7_,this.var_118.z - _loc7_);
               this.var_2651 = _loc8_;
