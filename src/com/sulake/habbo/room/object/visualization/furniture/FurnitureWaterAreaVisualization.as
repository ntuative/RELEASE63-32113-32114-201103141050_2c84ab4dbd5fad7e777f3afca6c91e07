package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1284:String = "shore";
      ...
      {
         if(this.var_2335 == param1 && this.var_2336 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1284)
            {
               this.var_1675 = _loc2_;
               this.var_2335 = param1;
               this.var_2336 = direction;
               return this.var_1675;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_488 == 0 || this.var_588 == 0)
         {
            ...
            this.var_488 = _loc2_.getNumber(RoomObjectVariableEnum.const_304);
            this.var_588 = _loc2_.getNumber(RoomObjectVariableEnum.const_372);
         }
         this.var_414 = [];
         this.var_589 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_488 * 2 + this.var_588 * 2)
         {
            this.var_414.push(false);
            this.var_589.push(ShoreMaskCreatorUtility.const_80);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_71,getSize(param3),this.var_414,this.var_589,assetCollection);
      }
