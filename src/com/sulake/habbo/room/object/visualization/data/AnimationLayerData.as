   ...
   public class AnimationLayerData
   {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc12_ = this.var_1751 * _loc11_;
            if(param5)
            {
               _loc12_ = 0;
            }
            _loc13_ = false;
            if(!this.var_1536 && !param2.isRandom)
            {
            ...
            return new AnimationFrame(_loc6_.id,_loc7_,_loc8_,_loc11_,_loc12_,_loc13_,param3,param4);
         }
         return null;
      }
   }
