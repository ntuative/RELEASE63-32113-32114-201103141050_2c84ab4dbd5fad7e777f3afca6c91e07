package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_97:int = 3;
      ...
      private var var_1207:Vector3d = null;
      ...
      private var var_962:IPlaneRasterizer = null;
      
      private var var_683:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1207 = new Vector3d();
         this.var_1207.assign(param1);
         ...
         this.var_639 = Vector3d.crossProduct(this.var_309,this.var_310);
         if(this.var_639.length > 0)
         {
            this.var_639.mul(1 / this.var_639.length);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_962.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_778 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_369))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_309.length * param1.scale;
            _loc6_ = this.var_310.length * param1.scale;
            _loc7_ = param1.getCoordinatePosition(this.var_639);
            _loc4_ = this.getTextureIdentifier(param1.scale);
            ...
            if(this.var_962 != null)
            {
               _loc3_ = this.var_962.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1884,this.var_2649,this.var_2647,this.var_2650,this.var_2648,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1902 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1384.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1384[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1207);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_166.z - originZ,this.var_119.z - originZ,this.var_87.z - originZ,this.var_118.z - originZ);
            if(this._type == const_97)
            {
               relativeDepth += 0.02;
            }
            this.var_2651 = relativeDepth;
            this._isVisible = true;
            this.var_1902 = geometry.updateId;
         }
      ...
      {
         this.var_166.assign(param1.getScreenPosition(this.var_80));
         this.var_119.assign(param1.getScreenPosition(Vector3d.sum(this.var_80,this.var_310)));
         this.var_87.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_80,this.var_309),this.var_310)));
         this.var_118.assign(param1.getScreenPosition(Vector3d.sum(this.var_80,this.var_309)));
         this._offset = param1.getScreenPoint(this.var_1207);
         ...
         var _loc2_:Number = Math.min(this.var_166.x,this.var_119.x,this.var_87.x,this.var_118.x);
         var _loc3_:Number = Math.max(this.var_166.x,this.var_119.x,this.var_87.x,this.var_118.x);
         var _loc4_:Number = Math.min(this.var_166.y,this.var_119.y,this.var_87.y,this.var_118.y);
         var _loc5_:Number = Math.max(this.var_166.y,this.var_119.y,this.var_87.y,this.var_118.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_166 == null || this.var_119 == null || this.var_87 == null || this.var_118 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_118.x - this.var_87.x;
         var _loc4_:Number = this.var_118.y - this.var_87.y;
         var _loc5_:Number = this.var_119.x - this.var_87.x;
         var _loc6_:Number = this.var_119.y - this.var_87.y;
         if(this._type == const_117 || this._type == const_97)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_117 || this._type == const_97))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_273.length == this.var_964.length)
         {
            while(_loc1_ < this.var_273.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_964.length)
                  {
                     _loc7_ = this.var_964[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_370.length > this.var_1461.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_963 || this.var_273.length == 0 && this.var_370.length == 0 && !this.var_369 || this.var_683 == null)
         {
            return;
         }
         ...
         if(this.var_369)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_639);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_273.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc3_.leftSideLoc / this.var_309.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc3_.rightSideLoc / this.var_310.length;
                  _loc12_ = _loc3_.type;
                  this.var_683.updateMask(this.var_71,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_964.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_370.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc4_.leftSideLoc / this.var_309.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc4_.rightSideLoc / this.var_310.length;
                  _loc13_ = this.var_71.width * _loc4_.leftSideLength / this.var_309.length;
                  _loc14_ = this.var_71.height * _loc4_.rightSideLength / this.var_310.length;
                  this.var_71.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1461.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_369 = false;
