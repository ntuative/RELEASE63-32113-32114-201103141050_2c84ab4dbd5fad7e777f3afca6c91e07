package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMaskManager
   {
      ...
      private var var_753:IGraphicAssetCollection = null;
                  ...
                  while(_loc11_ < _loc10_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc12_,_loc4_))
                     {
                        ...
                        if(_loc14_ != null)
                        {
                           ...
                           this.method_6(_loc15_,_loc14_,param2);
                        }
                     }
                     _loc11_++;
                  }
      ...
      private function method_6(param1:XMLList, param2:PlaneMaskVisualization, param3:IGraphicAssetCollection) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = NaN;
         var _loc7_:* = NaN;
