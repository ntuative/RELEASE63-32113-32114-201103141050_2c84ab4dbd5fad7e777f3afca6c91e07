package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1733:String = "no_reqs_info";
      ...
      private var var_1940:IContainerButtonWindow;
      ...
      {
         this.var_1940 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1941 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1941.procedure = this.onDismissAllButtonClick;
         this.var_1940.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_171)
         {
         ...
         else if(param1.state == FriendRequest.const_1118)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_281,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_346 && _loc4_.state != FriendRequest.const_394)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_281,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1940,_loc1_);
         this.setEnabled(this.var_1941,_loc1_);
      }
