package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_718:ISessionDataManager;
      
      private var var_2329:FriendListLookAndFeel;
      
      private var var_398:FriendListTabs;
      
      private var var_16:FriendListView;
      
      private var var_1668:OpenedToWebPopup;
      
      private var var_2099:int;
      
      var var_98:FriendCategories;
      
      private var var_351:FriendRequests;
      
      private var var_1669:AvatarSearchResults;
      
      private var var_187:IHabboToolbar;
      
      private var var_860:IHabboNotifications;
      
      private var var_587:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2329 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_98 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1669 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_587.stop();
            this.var_587.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_587 = null;
         }
         ...
         if(this.var_860)
         {
            this.var_860.release(new IIDHabboNotifications());
            this.var_860 = null;
         }
         if(this.var_187)
         {
         ...
         if(this.var_718)
         {
            this.var_718.release(new IIDSessionDataManager());
            this.var_718 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1668 = new OpenedToWebPopup(this);
         }
         this.var_1668.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_98.findFriend(param1);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_98.getFriendCount(param1,param2);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_351.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_187.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_302,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboAchievementShareIdMessageParser";
      }
      ...
      {
         this.var_187 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_860 = param2 as IHabboNotifications;
      ...
      {
         this.var_718 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_351 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_98.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_98.addCategory(new FriendCategory(FriendCategory.const_1169,this.getText("friendlist.friends")));
         this.var_98.addCategory(new FriendCategory(FriendCategory.const_361,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_98.addFriend(new Friend(_loc4_));
         }
         this.var_398 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_587)
         {
            this.var_587 = new Timer(120000);
            this.var_587.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_587.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.FRIENDLIST));
         this.var_187.events.addEventListener(HabboToolbarEvent.const_37,this.onHabboToolbarEvent);
         if(this.var_98.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_98.findCategory(FriendCategory.const_361);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this.var_16.openFriendList();
            _loc1_ = this.var_398.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_351.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.method_4)
         {
            this.var_351.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.method_4.length > 0)
         {
            this.var_398.findTab(FriendListTab.const_95).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_351.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_398.findTab(FriendListTab.const_95);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1669.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_98.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_98.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_398.findTab(FriendListTab.const_95);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_718 || !this.var_351)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_718.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_351.vipLimit;
         }
         else if(this.var_718.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_351.clubLimit;
         }
         if(_loc2_ > this.var_351.limit)
         {
            this.var_351.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(disposed || this.var_98 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_98.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
