package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1770:int = "F".charCodeAt(0);
      
      public static const const_1908:int = "M".charCodeAt(0);
      ...
      private var var_1234:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_758 = param1.online;
         this.var_1602 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1942 = param1.motto;
         this.var_1803 = param1.lastAccess;
         this.var_1489 = param1.categoryId;
         this.var_1804 = param1.realName;
