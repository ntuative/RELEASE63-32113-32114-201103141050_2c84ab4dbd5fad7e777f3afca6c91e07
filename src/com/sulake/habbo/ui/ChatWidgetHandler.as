package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_799:Point = null;
      
      private var var_526:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1232 = [];
         this.var_526 = new Vector3d();
         super();
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_440.length)
            {
               _loc2_ = this.var_440.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_316 != null)
         {
            ...
            {
               _loc2_ = this.var_316.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_754,RoomWidgetChatSelectAvatarMessage.const_675];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_754:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_998))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_998))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_675:
      ...
      {
         return [RoomSessionChatEvent.const_174];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_174:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_196)
                           {
                              _loc13_ = this.var_316.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_440.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_651.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_196:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_651.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_196)
                                    {
                                       this.var_316.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_440.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_799 == null)
            {
               ...
               this.var_526.y = 0;
               this.var_526.z = 0;
               this.var_799 = _loc4_.getScreenPoint(this.var_526);
            ...
            this.var_526.y = 0;
            this.var_526.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_526);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_799.x || _loc8_.y != this.var_799.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_799,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_316)
         {
            _loc2_ = this.var_316.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_440)
         {
            _loc2_ = this.var_440.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1232.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_651.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1938.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1938.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_316)
            {
               this.var_316.add(_loc3_,param2);
            }
         }
      }
   }
