   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_652,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_739,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_187 != null)
            {
               this.var_187.events.removeEventListener(HabboToolbarEvent.const_71,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_429,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_652,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_739,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_429,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1428)
            {
               ...
               this.var_1843 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1843;
            }
         }
         if(this.var_187 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1190,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_187.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_670);
         _loc1_.push(RoomWidgetDanceMessage.const_885);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_810);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_701);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_829);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_664);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_868);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_355);
         _loc1_.push(RoomWidgetStopEffectMessage.const_841);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1399);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1095);
         _loc1_.push(RoomWidgetToolbarMessage.const_630);
         _loc1_.push(RoomWidgetToolbarMessage.const_817);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_382);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1388);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1193);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_844);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_781);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_808);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1385);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_722);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_720);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_753);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_781:
               ...
               break;
            case RoomWidgetWaveMessage.const_670:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_885:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_810:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_701:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_829:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_355:
            ...
            case RoomWidgetStopEffectMessage.const_841:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1084:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1490:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1095:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_844:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_630:
               ...
               if(this.var_187)
               {
                  this.var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_817:
               ...
               {
                  this.var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_500,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_382:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_461));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_808:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_369,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_722:
            ...
            case RoomWidgetStoreSettingsMessage.const_720:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_369,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_753:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_336:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_890));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_865));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_429:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_577));
         }
      }
