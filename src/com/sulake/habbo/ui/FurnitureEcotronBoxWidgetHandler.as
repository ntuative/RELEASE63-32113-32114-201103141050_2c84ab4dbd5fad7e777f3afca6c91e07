package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_744,RoomWidgetEcotronBoxOpenMessage.const_851,RoomWidgetEcotronBoxOpenedMessage.const_1534];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_744:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_851:
