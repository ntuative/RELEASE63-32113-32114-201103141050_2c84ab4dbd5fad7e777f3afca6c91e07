package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_105,this.onPetInfo);
         ...
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_105,this.onPetInfo);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_386);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_858);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_907);
         ...
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_637);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_640);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1545);
         _loc1_.push(RoomWidgetPetCommandMessage.const_473);
         _loc1_.push(RoomWidgetPetCommandMessage.const_797);
         _loc1_.push(RoomWidgetUserActionMessage.const_457);
         _loc1_.push(RoomWidgetUserActionMessage.const_405);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_804);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_575)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_405 || param1.type == RoomWidgetUserActionMessage.const_457 || param1.type == RoomWidgetUserActionMessage.const_491)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_386:
            ...
            case RoomWidgetUserActionMessage.const_767:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1174,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_563:
               ...
               break;
            case RoomWidgetUserActionMessage.const_858:
            ...
            case RoomWidgetUserActionMessage.const_688:
               ...
               break;
            case RoomWidgetUserActionMessage.const_907:
            ...
            case RoomWidgetFurniActionMessage.const_719:
               ...
               break;
            case RoomWidgetUserActionMessage.const_405:
            ...
            case RoomWidgetRoomTagSearchMessage.const_752:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_637:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_640:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_313);
               _loc6_.id = param1.id;
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1058);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_189)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_872)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_555);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_115)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_136)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_895);
                  ...
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1123;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1652);
               }
               else
               {
               ...
               if(_loc20_ != null)
               {
                  ...
                  _loc13_.image = _loc20_.getImage(AvatarSetType.const_36,true);
                  _loc20_.dispose();
               }
