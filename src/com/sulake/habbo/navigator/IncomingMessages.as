package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboNavigator)
      {
         ...
         _loc2_.addHabboConnectionMessageEvent(new OfficialRoomsEvent(this.method_7));
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1170)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1514)
         {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.ROOMINFO));
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "HabboAchievementShareIdMessageParser" && false)
         {
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_252);
      }
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         {
            case CantConnectMessageParser.const_1628:
            ...
            case CantConnectMessageParser.const_1579:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1456:
