package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1809:IButtonWindow;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1809 = IButtonWindow(this.find("top_tab"));
         this.var_1808 = IButtonWindow(this.find("obj_tab"));
         this.var_2562 = IWindowContainer(this.find("tile_grid"));
         this.var_2561 = IWindowContainer(this.find("now_editing_container"));
         ...
         Util.setProcDirectly(this.var_1809,this.onTopTabButton);
         Util.setProcDirectly(this.var_1808,this.onObjTabButton);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_67.mode = ThumbnailEditorModel.const_59;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1807,this.var_67.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_1809,this.var_67.mode != ThumbnailEditorModel.const_59);
         this.setEnabled(this.var_1808,this.var_67.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function refreshEditArea() : void
      {
         ...
         this.refreshEditImg(_loc1_,"edit_top",this.var_67.mode == ThumbnailEditorModel.const_59);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_508)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_62,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_460,HabboWindowStyle.const_43,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_302,HabboWindowStyle.const_43,HabboWindowParam.const_60,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
