package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_427:IRoomSettingsCtrlOwner;
      ...
      private var var_937:TextFieldManager;
      
      private var var_1175:TextFieldManager;
      
      private var var_1176:ICheckBoxWindow;
      
      private var var_1174:ICheckBoxWindow;
      
      private var var_1173:ICheckBoxWindow;
      
      private var var_620:ICheckBoxWindow;
      ...
      private var var_2579:ITextWindow;
      ...
      {
         this.var_360 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_360));
         if(this.var_1169 != null)
         {
            this.var_1169.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_360)
         {
            return;
         }
         this.var_77 = param1;
         this._active = true;
         this.var_1817 = true;
         this.var_427.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_360)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_360 || this.var_1177 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1177 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1650)
         {
            this.var_762.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1402)
         {
            this.var_762.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1551)
         {
            this.var_1170.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1670)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1387)
         {
            this.var_937.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_937.clearErrors();
         this.var_1175.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_477,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_685,this.onDoorModePasswordUnselect);
         ...
         this.var_1170 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_939 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_938 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_937 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1175 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1176 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1174 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1173 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_620 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1819 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1418 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1172 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1171 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1818 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1417 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_266 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1169 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2579 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2578 = ITextWindow(this._window.findChildByName("advanced_caption"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1819.visible = this._inRoom;
         this.var_1818.visible = this._inRoom;
         this.var_2578.visible = this.var_506;
         this.var_2579.visible = !this.var_506;
         if(this.var_506)
         {
         ...
         else
         {
            ...
            this.var_1418.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1418.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1172.height = Util.getLowestPoint(this.var_1172) + 4;
         }
         this.var_1419.text = !!this.var_506 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1819.name,this.var_1418.name,this.var_1172.name,this.var_1171.name,this.var_1417.name,this.var_1818.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1170.setText(_loc1_.description);
         this.var_937.setText("");
         this.var_1175.setText("");
         ...
         this.setTag(this.var_939,_loc1_.tags[0]);
         this.setTag(this.var_938,_loc1_.tags[1]);
         if(this.var_1176)
         {
            if(_loc1_.allowPets)
            {
               this.var_1176.select();
            }
            else
            {
               this.var_1176.unselect();
            }
         }
         if(this.var_1174)
         {
            ...
            {
               this.var_1174.select();
            }
            else
            {
               this.var_1174.unselect();
            }
         }
         if(this.var_1173)
         {
            ...
            {
               this.var_1173.select();
            }
            else
            {
               this.var_1173.unselect();
            }
         }
         if(this.var_620)
         {
            ...
            {
               this.var_620.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_620.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1170.getText();
         ...
         {
            _loc8_ = this.var_937.getText();
            _loc9_ = this.var_1175.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_937.clearErrors();
               this.var_1175.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1176.isSelected;
         _loc2_.allowFoodConsume = this.var_1174.isSelected;
         _loc2_.allowWalkThrough = this.var_1173.isSelected;
         _loc2_.hideWalls = this.var_620.isSelected;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_360);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_77.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_360]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_62,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_360));
      }
