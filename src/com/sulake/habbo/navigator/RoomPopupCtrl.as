package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2108 = new RoomThumbnailRenderer(param1);
         this.var_1123 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_177,this.var_108);
         if(this.var_108.ownerName != "" && this.var_108.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_177,!!this.var_108.event ? this.getEventCtg(this.var_108.categoryId) : this.getRoomCtg(this.var_108.categoryId));
         this.refreshRoomDesc(this.var_177,this.var_108);
         this.refreshExtraCont();
         this.refreshInfo(this.var_177,"trading_allowed",this.var_108.allowTrading);
         this.refreshInfo(this.var_177,"doormode_doorbell",this.var_108.doorMode == 1);
         this.refreshInfo(this.var_177,"doormode_password",this.var_108.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_177,this.var_108.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1123.refreshTags(_loc1_,this.var_108.tags);
         ...
         this.var_2108.refreshThumbnail(_loc1_,this.var_108.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_267,Tabs.const_257,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
