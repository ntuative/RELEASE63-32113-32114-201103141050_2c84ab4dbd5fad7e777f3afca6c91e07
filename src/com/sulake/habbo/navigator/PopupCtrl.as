package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_410.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_410)
         {
            this.var_410.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_410.reset();
            this.var_410 = null;
         }
         if(this.var_349)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_54 == null)
         {
            this.var_54 = IWindowContainer(this._navigator.getXmlWindow(this.var_1017));
         ...
         this.var_54.x = _loc2_.x + this.var_2291 + param1.width;
