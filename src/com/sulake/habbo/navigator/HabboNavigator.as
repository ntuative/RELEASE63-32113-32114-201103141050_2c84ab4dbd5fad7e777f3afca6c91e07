package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_572:RoomInfoViewCtrl;
      
      private var var_1063:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_398:Tabs;
      ...
      private var var_2108:RoomThumbnailRenderer;
      
      private var var_937:GuestRoomPasswordInput;
      
      private var var_320:GuestRoomDoorbell;
      
      private var var_1062:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_572 = new RoomInfoViewCtrl(this);
         this.var_1063 = new RoomCreateViewCtrl(this);
         this.var_2108 = new RoomThumbnailRenderer(this);
         this.var_937 = new GuestRoomPasswordInput(this);
         this.var_320 = new GuestRoomDoorbell(this);
         this.var_398 = new Tabs(this);
         this.var_1062 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_302,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_572.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_287.startSearch(Tabs.const_267,Tabs.const_337,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_287.startSearch(Tabs.const_305,Tabs.const_252);
         this.var_398.getTab(Tabs.const_305).tabPageDecorator.tabSelected();
      }
