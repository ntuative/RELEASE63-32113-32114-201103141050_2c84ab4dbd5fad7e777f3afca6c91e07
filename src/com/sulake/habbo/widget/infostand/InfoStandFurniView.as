package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_973 = this.var_205.findChildByTag("catalog");
         if(this.var_973 != null)
         {
            this.var_973.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_973);
            }
            this.var_973.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_973);
         }
      }
   }
}
