package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_205:IBorderWindow;
      ...
      private const const_2007:int = 152;
      
      private const const_2010:int = 16;
      
      private const const_1372:int = 4;
      
      private const const_2014:uint = 14342874;
      
      private const const_2012:uint = 3815994;
      
      private const const_2013:uint = 2085362;
      
      private const const_2009:uint = 39616;
      
      private const const_2002:uint = 10513106;
      
      private const const_2003:uint = 8734654;
      
      private const const_2006:uint = 9094430;
      
      private const const_2004:uint = 6200576;
      
      private const const_2011:String = "happiness";
      
      private const const_2008:String = "experience";
      
      private const const_2005:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_205 == null || this.var_68 == null)
         {
            return;
         }
         ...
         this.var_205.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_205.width,this.var_68.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_205.width < this.var_68.width)
         {
            this.var_205.x = this._window.width - this.var_205.width;
            this.var_68.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2011,param1.nutrition,param1.nutritionMax,this.const_2009,this.const_2013);
         this.updateStateElement(this.const_2008,param1.experience,param1.experienceMax,this.const_2003,this.const_2002);
         this.updateStateElement(this.const_2005,param1.energy,param1.energyMax,this.const_2004,this.const_2006);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2007,this.const_2010,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2014);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2012);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1372,_loc7_.width - 2,_loc7_.height - 2 - this.const_1372);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1372);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_505) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_205 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_205 != null)
         {
            this.var_53 = this.var_205.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_205.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_205.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_205.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_205.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_205.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
         ...
         for each(_loc11_ in _loc10_)
         {
            ...
            _loc11_.addEventListener(WindowEvent.const_51,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_206 && this.var_206.getPetId() == this.var_505)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_563,this._widget.petData.ownerId);
