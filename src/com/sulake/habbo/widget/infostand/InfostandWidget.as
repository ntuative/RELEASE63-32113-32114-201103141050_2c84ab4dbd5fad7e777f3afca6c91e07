package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1711:String = "infostand_user_view";
      
      private const const_1712:String = "infostand_furni_view";
      
      private const const_1714:String = "infostand_pet_view";
      
      private const const_1713:String = "infostand_bot_view";
      
      private var var_1135:InfoStandFurniView;
      
      private var var_131:InfoStandUserView;
      
      private var var_355:InfoStandPetView;
      
      private var var_419:InfoStandBotView;
      
      private var var_2443:Array;
      
      private var var_1376:InfostandUserData;
      
      private var var_619:InfostandFurniData;
      ...
      private const const_1988:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1135 = new InfoStandFurniView(this,this.const_1712,this._catalog);
         this.var_131 = new InfoStandUserView(this,this.const_1711);
         this.var_355 = new InfoStandPetView(this,this.const_1714,this._catalog);
         this.var_419 = new InfoStandBotView(this,this.const_1713);
         this.var_1376 = new InfostandUserData();
         this.var_619 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_161 = new Timer(this.const_1988);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_646,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_683,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_646,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_683,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_405,this.var_355.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1711);
         if(this.var_161)
         {
            this.var_161.stop();
         }
      ...
      {
         this.userData.setData(param1);
         this.var_419.update(param1);
         this.selectView(this.const_1713);
         if(this.var_161)
         {
            this.var_161.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1712);
         if(this.var_161)
         {
            this.var_161.stop();
         }
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_355.update(this.petData);
         this.selectView(this.const_1714);
         if(this.var_161)
         {
            this.var_161.start();
         }
      ...
      {
         this.var_355.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_131.setTags(param1.tags,this.var_2443);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_419.image = param1.image;
         }
         else
         {
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_419.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_168:
               ...
               if(this.var_419 != null && this.var_419.window != null && this.var_419.window.visible)
               {
                  _loc2_ = param1.id == this.var_1376.userRoomId;
                  break;
               }
