package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_610:IWindow;
      
      private var var_205:IBorderWindow;
      
      private var var_1123:TagListRenderer;
      
      private var var_134:IBorderWindow;
      
      private var var_2499:int;
      
      private const const_948:int = 5;
      
      private const const_1715:int = 39;
      
      private const const_1716:int = 7829367;
      
      private const const_1717:int = 16777215;
      
      private const const_1991:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1123 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_51,this.onButtonResized);
         }
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_205.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_205.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_205.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_205.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_948;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1716;
            }
            else
            {
               _loc3_.textColor = this.const_1717;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_948;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_341,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_341,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1123.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1160:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1123:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2499 > this.const_1991 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2499 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1716;
            if(_loc3_.length >= this.const_1715)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1715 - 1);
            }
         }
      }
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            if(param2.name == "button.give")
            {
               ...
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_610);
               }
               if(_loc3_ <= -1)
               {
                  return;
