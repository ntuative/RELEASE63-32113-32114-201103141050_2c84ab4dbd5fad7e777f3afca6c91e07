package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1212:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1213 = 0;
         this.var_1212 = param2.rectangle.clone();
         this.var_1212.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1212.width)
         {
            return false;
         }
         if(this.var_1213 + param1.height > this.var_1212.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1212.width)
         {
            this._offsetX = 0;
            this.var_1213 += param1.height + this.const_1999;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1213);
         this._offsetX += param1.width + this.const_2000;
         return true;
      }
