package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1238,const_1239,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_403 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_248 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_248.numTabItems)
         {
            _loc6_ = this.var_248.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1303 = _loc2_.light;
         if(this.var_403 != null)
         {
            this.var_403.setValue(this.var_1303);
         }
         this.var_523 = this.colors.indexOf(_loc2_.color);
         if(this.var_562 != null)
         {
            this.var_562.setSelectedColorIndex(this.var_523);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_248.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_248.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_248.selector.getSelected();
         return this.var_248.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1302 = XML(_loc1_.content);
         return this.var_1302;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_403 != null)
         {
            this.var_403.min = this._widget.minLights[param1 - 1];
         }
      }
