package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1700:int = 0;
      
      private const const_1704:int = 1;
      
      private const const_1702:int = 2;
      
      private const const_1706:int = 3;
      
      private const const_1705:int = 4;
      
      private const const_1977:int = 0;
      
      private const const_1982:int = 1;
      
      private const const_1983:int = 2;
      
      private const const_1984:int = 3;
      
      private const const_1981:int = 4;
      
      private const const_1985:int = 5;
      
      private const const_1701:String = "deco_img";
      
      private const const_1703:String = "dialog_bg";
      
      private const const_1978:String = "%campaign%_dialog_bg.png";
      
      private const const_330:String = "%campaign%_gift_package.png";
      
      private const const_1979:String = "%campaign%_gift_content.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1344 = this.var_159.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1344 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1345.length)
         {
            _loc2_ = this.var_1345.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_159 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_445,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_745,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_660,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_445,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_445:
               _loc2_ = this.const_1700;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_660:
               ...
               {
                  _loc2_ = this.const_1705;
               }
               this._shareId = null;
               this.var_1343 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_745:
         ...
         if(this._window && (this.var_1346 != _loc2_ || _loc3_ != this.var_184))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1346)
            {
               ...
               case this.const_1704:
                  if(this.var_388 == this.const_1977)
                  {
                  ...
                  else if(this.var_388 == this.const_1982)
                  {
                     ...
                     _loc2_ = this.const_1979;
                  }
                  else if(this.var_388 == this.const_1983)
                  {
                  ...
                  else if(this.var_388 == this.const_1984)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_388 == this.const_1981)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_184,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_388 == this.const_1985)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_1978.replace("%campaign%",this.var_184);
            this.setDecoImage(_loc5_,this.const_1703);
            _loc2_ = _loc2_.replace("%campaign%",this.var_184);
            this.setDecoImage(_loc2_,this.const_1701);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_668);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_162);
            _loc2_.objectId = this.var_333;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
         if(this._inventory)
         {
            if(this.var_1343 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1343 == 1 ? "null" : InventoryCategory.const_131);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_867,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1345.push(new ImageDownloader(this,_assets,this.var_184,this.var_1344,param1,param2));
            return;
         }
