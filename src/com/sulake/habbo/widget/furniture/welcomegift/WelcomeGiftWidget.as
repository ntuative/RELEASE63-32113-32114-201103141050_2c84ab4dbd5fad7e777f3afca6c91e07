package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_610:String = "welcome_gift_email_unverified";
      
      private const const_975:String = "welcome_gift_email_verified";
      
      private const const_1367:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1218)
         {
            this.setViewState(this.const_975);
         }
         else
         {
            this.setViewState(this.const_610);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_610:
               ...
               this.var_16.findChildByName("edit").visible = this.var_2610;
               break;
            case this.const_975:
      ...
      {
         this.setViewState(this.const_1367);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_839,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1218 ? this.const_975 : this.const_610);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_16.findChildByName("cancel_email_change").setParamFlag(WindowParam.const_31,false);
         this.setButtonState("save_email",false);
         _loc2_.editable = false;
         _loc2_.selectable = false;
         this.var_1217 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1217));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_425,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_859,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_425,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_859,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_425:
               this.var_1217 = param1.email;
               this.var_1218 = param1.isVerified;
               this.var_2610 = param1.allowEmailChange;
