package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2817:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2817 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_371:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_74,this.var_159,this.var_2241++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_74,this);
               break;
            case RoomWidgetEnum.const_475:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_74,this.var_159,this._catalog);
               break;
            case RoomWidgetEnum.const_564:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_74,events,this.var_159);
               break;
            case RoomWidgetEnum.const_723:
               _loc2_ = new PlaceholderWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_507:
               _loc2_ = new CreditFurniWidget(this._windowManager,assets,this.var_74);
               break;
            ...
            case RoomWidgetEnum.const_527:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_74,this.var_159,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_113:
               _loc2_ = new DoorbellWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_446:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_74,this.var_159);
               break;
            case RoomWidgetEnum.const_648:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_74,this.var_159);
               break;
            case RoomWidgetEnum.const_124:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_74,this.var_159);
               break;
            case RoomWidgetEnum.const_378:
               _loc2_ = new PollWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_290:
               _loc2_ = new UserChooserWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_528:
               _loc2_ = new FurniChooserWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_471:
               _loc2_ = new DimmerFurniWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_141:
               _loc2_ = new FriendRequestWidget(this._windowManager,assets,this.var_74,this);
               break;
            case RoomWidgetEnum.const_572:
               _loc2_ = new ClothingChangeFurnitureWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_665:
               _loc2_ = new RoomWidgetBase(this._windowManager);
               break;
            case RoomWidgetEnum.const_118:
               _loc2_ = new UserNotificationWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_384:
               _loc2_ = new PurseWidget(this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_123:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this.var_74,this);
               break;
            case RoomWidgetEnum.const_533:
               _loc2_ = new WelcomeGiftWidget(this._windowManager,assets,this.var_74);
         }
         return _loc2_;
      }
   }
