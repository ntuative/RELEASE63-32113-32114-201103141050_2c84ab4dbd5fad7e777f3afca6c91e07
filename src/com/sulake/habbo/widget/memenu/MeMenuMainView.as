      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1159);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1106));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_729);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_321);
               break;
            case "hc":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "HabboAchievementShareIdMessageParser";
               if(false && _loc4_)
               {
