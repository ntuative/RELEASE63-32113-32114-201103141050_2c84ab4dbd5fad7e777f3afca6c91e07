package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private var var_428:Boolean = false;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_188.state = RoomChatHistoryPulldown.const_250;
         ...
         this.var_48 = param2.createWindow("chatscroller","",HabboWindowType.const_1048,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_188.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_250);
      }
      ...
      {
         return !!this.var_428 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_188.state == RoomChatHistoryPulldown.const_374 || this.var_188.state == RoomChatHistoryPulldown.const_565;
      }
      ...
      {
         if(!this.var_428 && !this.var_1688)
         {
            this.var_428 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_188.state = RoomChatHistoryPulldown.const_374;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_48 != null)
         {
            ...
            if(param2)
            {
               this.var_48.scrollV = this.var_623;
            }
         }
         if(this.var_188 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_429 > 0 && param2)
         {
            if(this.var_1837)
            {
               if(Math.abs(param1 - this.var_429) <= const_1143)
               {
                  return;
               }
               this.var_1837 = false;
            ...
            if(this.var_428)
            {
               ...
               _loc5_ = (param1 - this.var_429) / this.var_48.height;
               _loc3_ = this.var_623 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_429;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_48.scrollV < 1 - const_1328 / this.var_48.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1836)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_48 != null)
         {
            this.var_623 = this.var_48.scrollV;
         }
         if(this.var_48 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_623 - this.var_48.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
