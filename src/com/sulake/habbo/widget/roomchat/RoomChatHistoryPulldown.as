package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_940:int = 150;
      
      private static const const_941:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_39 = param3;
         this.var_2422 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1721 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2425 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1722 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1723 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2421 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2424 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_76 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_302,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,param3.width,param3.height - const_83),null,0,0) as IBitmapWrapperWindow;
         this.var_39.addChild(this.var_76);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,this.var_39.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_39.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_460,HabboWindowStyle.const_43,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_565:
               this.var_76.blend += param1 / const_941;
               this._window.blend += param1 / const_941;
               ...
               break;
            case const_927:
               this.var_76.blend -= param1 / const_940;
               this._window.blend -= param1 / const_940;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_39.width - this.var_2426;
         }
         if(this.var_76 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         {
            _loc5_.bitmap = this.var_2425;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1722;
            _loc2_.disposesBitmap = false;
            this.var_2426 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2422,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1721,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1721,_loc9_);
         ...
         this.var_76.bitmap = this.var_2424;
