package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_919 + const_1261)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1260;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_474 == null || _loc1_.id != this.var_474.id)
         {
            this.var_474 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_474.followingAllowed)
         {
            this.var_1576.enable();
         }
         else
         {
            this.var_1576.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_474.messages.length - const_919);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_474.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_474.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_861 || param3.type == Message.const_898 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_474.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_133.send(new FollowFriendMessageComposer(this.var_474.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1075)
         {
            return 4294927974;
         }
         if(param1 == Message.const_881)
         {
            return 4293454056;
         }
