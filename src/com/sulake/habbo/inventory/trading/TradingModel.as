package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_311:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_55.updateItemList(this.var_728);
         this.var_55.updateItemList(this.var_1354);
      ...
      public function close() : void
      {
         if(this.var_785)
         {
            if(this._state != const_183 && this._state != const_266)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_727 + " OTHER: " + this.var_1115);
         ...
         {
            case const_183:
               if(param1 == const_201 || param1 == const_266)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_260 == null || this.var_260.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         ...
         {
            _loc2_ = this.var_260.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1027);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_728)
            {
               this.var_727 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1115 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_55.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_728)
            {
               this.var_55.alertPopup(TradingView.const_1100);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_260.length < const_1641)
         {
         ...
         else
         {
            ...
            if(this.var_260.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
