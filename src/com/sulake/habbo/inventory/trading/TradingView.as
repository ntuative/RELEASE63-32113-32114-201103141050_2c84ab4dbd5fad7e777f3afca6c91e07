package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_968:uint = 4284532064;
      
      private static const const_967:uint = 2577770;
      ...
      private var var_432:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_432 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1864 = this.createMinimizedWindow();
         }
         if(!this.var_2609)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_968) : uint(const_967);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_968) : uint(const_967);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_432.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_478);
            this.var_432.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_432.hideDelayed();
         }
      }
