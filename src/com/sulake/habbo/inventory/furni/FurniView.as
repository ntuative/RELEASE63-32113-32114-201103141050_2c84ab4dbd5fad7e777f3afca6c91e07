package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2020:int = 0;
      
      private const const_973:int = 1;
      
      private const const_1691:int = 2;
      
      private const const_1690:int = 3;
      
      private const const_1728:int = 42;
      
      private const const_1729:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_517 = param6;
         this.var_517.events.addEventListener(SongInfoReceivedEvent.const_671,this.onSongInfoReceivedEvent);
         this.var_434 = new Map();
         this.var_434.add(FurniModel.const_45,new FurniGridView(this.var_67,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_434.add(FurniModel.const_50,new FurniGridView(this.var_67,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_517)
            {
               this.var_517.events.removeEventListener(SongInfoReceivedEvent.const_671,this.onSongInfoReceivedEvent);
               this.var_517 = null;
            }
            this.var_638 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_434.getValue(this.var_435);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_67.getCategoryContent(this.var_435);
         if(!this.var_67.isListInited())
         {
            _loc2_ = this.const_973;
         }
         ...
         if(this.var_2090 == _loc2_)
         {
            return;
         }
         this.var_2090 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_45,FurniModel.const_50];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_434.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_434.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_434.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_67.getGroupItemInIndex(_loc3_,this.var_435);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_390)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_722 && this.var_722.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1131)
               {
                  _loc21_ = this.var_517.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_517.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_638.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1131)
               {
                  _loc22_ = this.var_517.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1729)
         {
            _loc3_ = this.const_1729;
         }
         else if(_loc3_ < this.const_1728)
         {
            _loc3_ = this.const_1728;
         }
         else
         {
      ...
      {
         if(this.var_638.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_638.indexOf(param1.id as Number) != -1)
            {
               this.var_638.splice(this.var_638.indexOf(param1.id as Number),1);
            }
         }
      }
   }
