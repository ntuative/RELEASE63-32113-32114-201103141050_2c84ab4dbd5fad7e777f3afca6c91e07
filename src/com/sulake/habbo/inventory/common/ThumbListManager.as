package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1304:IThumbListDataProvider;
      
      private var var_212:int;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_90 = this.var_564.height;
         this.var_1052 = param5;
         this.var_853 = param6;
         this.var_212 = Math.floor(this.var_1052 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1052,this.var_853);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_563 = this.resolveRowCountFromList();
         if(this.var_563 == 0)
         {
            this.var_26 = new BitmapData(this.var_1052,this.var_853);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_212 * this._thumbWidth,this.var_1052),Math.max(this.var_563 * this.var_90,this.var_853),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_563)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_212)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_212 && this.var_26.height < _loc3_.y * this.var_90)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_212 - 1),this.var_90);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_212 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_90),null,null,true);
         _loc4_ = new Rectangle(0,this.var_90,this._thumbWidth * (this.var_212 - 1),this.var_26.height - this.var_90);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1304.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_212));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_212 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_212);
         var _loc3_:int = param1 % this.var_212;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_212)
         {
            return;
         }
         if(param1.y >= this.var_563)
         {
            return;
         }
         var _loc4_:int = this.var_212 - param1.x - 1;
         ...
         if(this.var_26.height < this.var_853)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_853);
