package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_822:int = 0;
      
      protected var var_663:BitmapData;
      
      protected var var_2334:int;
      
      protected var var_1520:Boolean;
      
      protected var var_2037:Boolean;
      
      protected var var_2800:BitmapData;
      
      private const const_1989:int = 8947848;
      
      private const const_1990:int = 13421772;
      
      private const const_1732:Number = 1;
      
      private const const_1731:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1385 = this._window.findChildByTag("BG_COLOR");
         this._roomEngine = param5;
         this.var_2800 = param6;
         this.var_2037 = param7;
         this._items = new Map();
         this.var_2799 = param2;
         this._category = param3;
         this.var_2032 = param8;
         this.var_1334 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2799 == FurniModel.const_45)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1334));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2032);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_622)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1731;
               _loc1_.blend = this.const_1731;
            }
            else
            {
               this._window.blend = this.const_1732;
               _loc1_.blend = this.const_1732;
            }
         }
         if(this.isSelected)
         {
            this.var_1385.color = this.const_1989;
         }
         else
         {
            this.var_1385.color = this.const_1990;
         }
         ...
         if(_loc5_)
         {
            if(this.var_2037 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2800;
               _loc5_.visible = true;
            }
            else
            {
