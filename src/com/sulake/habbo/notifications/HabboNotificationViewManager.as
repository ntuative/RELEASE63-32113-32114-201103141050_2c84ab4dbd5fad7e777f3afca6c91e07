package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_937:int = 32;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2375,this.var_408,this.var_187,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_658 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         {
            _loc3_ = this.var_217[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_658 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_658 + const_1299;
            _loc2_++;
         }
         return _loc1_;
      }
