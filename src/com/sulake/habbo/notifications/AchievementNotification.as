package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1722:String = "badge_bg_001_png";
      
      private const const_1995:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1434 = param7;
         this.var_2261 = param5;
         this.var_1854 = param6;
         this.var_74 = param10;
         this._assets = param8;
         this.var_290 = param13;
         ...
         this._window.center();
         this.var_2593 = this.var_74.getBadgeName(this.var_306);
         this.var_2594 = this.var_74.getBadgeDesc(this.var_306);
         this.var_2596 = this.var_74.getAchievementNameForFacebook(this.var_306,this.var_290.userName,this.var_290.realName,this.var_1435);
         this.var_2597 = this.var_74.getAchievementDescForFacebook(this.var_306,this.var_290.userName,this.var_290.realName,this.var_1435);
         ...
         this.var_74.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1667.toString());
         this.var_74.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1434.toString());
         this.var_74.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1434.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1854;
         var _loc17_:String = this.var_1854 == 0 ? "pixels" : "activitypoints";
         this.var_74.registerParameter(_loc16_,_loc17_,"" + this.var_2261);
         _loc15_.caption = this.var_74.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1722);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1995) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1434 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_306,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_306,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_306,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_74.registerParameter(param1,"badge_name",this.var_2593);
         this.var_74.registerParameter(param1,"badge_desc",this.var_2594);
         this.var_74.registerParameter(param1,"badge_name_fb",this.var_2596);
         this.var_74.registerParameter(param1,"badge_desc_fb",this.var_2597);
         this.var_74.registerParameter(param1,"level",this.var_1435.toString());
         this.var_74.registerParameter(param1,"name",this.var_290.userName);
         return this.var_74.registerParameter(param1,"realname",this.var_290.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_290.events.removeEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImageReady);
            this.var_290 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_306)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1722);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_306,this._feedTitleFb,this.var_2595,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2592));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_306,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_306,"client.skip_post"));
               this.dispose();
               return;
         }
      }
