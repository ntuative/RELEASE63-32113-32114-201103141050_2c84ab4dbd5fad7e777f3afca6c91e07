package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_484:UserInfoCtrl;
      
      private var var_1075:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_51,this.onResized);
         }
         ...
         this.var_484 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_1075 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_484.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1075.load(_loc4_,this.var_153.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_64,WindowTracker.const_1168,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_484 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
            this.var_484.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
