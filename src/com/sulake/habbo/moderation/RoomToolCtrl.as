package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1149:IDropMenuWindow;
      
      private var var_492:ITextFieldWindow;
      
      private var var_581:Boolean = true;
      
      private var var_925:ICheckBoxWindow;
      
      private var var_1400:ICheckBoxWindow;
      
      private var var_1399:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_360));
         Logger.log("BEGINNING TO SHOW: " + this.var_360);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1615;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_360);
         if(param1.flatId != this.var_360)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_360);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1149 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1149);
         this.var_1149.procedure = this.onSelectTemplate;
         this.var_925 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1400 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1399 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_886,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_925.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1554,_loc2_,this.var_492.text,"",""));
         if(this.var_1400.isSelected || this.var_1399.isSelected || this.var_925.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1400.isSelected,this.var_1399.isSelected,this.var_925.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1596);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1406);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1149.selection];
         if(_loc3_ != null)
         {
            this.var_581 = false;
