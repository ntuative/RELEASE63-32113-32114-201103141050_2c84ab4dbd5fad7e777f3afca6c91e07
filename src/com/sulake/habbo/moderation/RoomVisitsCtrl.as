package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_945:Array = [];
      
      private static var var_1844:int = 200;
      ...
      {
         this.var_768 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_945.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_768.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_945.length < var_1844)
         {
            ...
            param1.width = this.var_768.width;
            param1.height = this.var_768.height;
            var_945.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1430)
         {
