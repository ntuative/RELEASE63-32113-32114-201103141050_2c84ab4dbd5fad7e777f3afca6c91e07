package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1002:Array = [];
      
      private static var var_1962:int = 1000;
      ...
      private var var_1678:IMessageComposer;
      ...
      private var var_1963:Dictionary;
      ...
      {
         this.var_803 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_802 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_485 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1678);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1002.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1963[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1502.getValue(param2.chatterName))
            {
               this.var_1502.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1502.getValue(_loc2_);
      ...
      {
         if(param1.type != WindowEvent.const_51 || param2 != this._frame)
         {
            return;
         }
         this.var_485.reset();
