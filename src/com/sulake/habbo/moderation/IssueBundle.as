package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_703:IssueMessageData = null;
      
      private var var_704:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2266 = param2.pickerUserId;
         this.var_2265 = param2.pickerUserName;
         this.var_1401 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1078 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1079;
         }
         if(this.var_703 == null || param1.timeStamp < this.var_703.timeStamp)
         {
            this.var_703 = param1;
         }
         if(this.var_704 == null || param1.priority > this.var_704.timeStamp)
         {
            this.var_704 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1078 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1079;
            }
            if(this.var_703 == _loc2_)
            {
               this.var_703 = null;
            }
            if(this.var_704 == _loc2_)
            {
               this.var_704 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_704;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_703;
         if(_loc2_ == null)
         {
