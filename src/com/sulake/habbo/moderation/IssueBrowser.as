package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1971:String = "my_issues";
      
      private const const_1973:String = "open_issues";
      
      private const const_1972:String = "picked_issues";
      ...
      private var var_1582:IIssueBrowserView;
      
      private var var_1583:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_248 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_248.numTabItems)
            {
               _loc5_ = this.var_248.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_64,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_248 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_248 == null || this.var_248.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_248.selector.getSelectableByName("open_issues");
         this.var_248.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_340.view.width = this.var_248.container.width;
         this.var_340.view.height = this.var_248.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1971:
               ...
               {
                  this.var_1584 = new MyIssuesView(this.issueManager,this,this.var_248.container);
               }
               return this.var_1584;
            case this.const_1973:
               if(this.var_1582 == null)
               {
                  this.var_1582 = new OpenIssuesView(this.issueManager,this,this.var_248.container);
               }
               return this.var_1582;
            case this.const_1972:
               if(this.var_1583 == null)
               {
                  this.var_1583 = new PickedIssuesView(this.issueManager,this,this.var_248.container);
               }
