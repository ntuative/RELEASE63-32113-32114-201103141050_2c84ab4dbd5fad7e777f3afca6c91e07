package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_886:int = 4;
      
      public static const const_1181:int = 5;
      
      public static const const_1549:int = 6;
      
      public static const const_1525:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1615:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1631[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1631[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
