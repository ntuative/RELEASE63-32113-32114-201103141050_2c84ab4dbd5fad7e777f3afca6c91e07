package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_497:Quest;
      
      private var var_195:QuestView;
      ...
      private var var_299:IItemListWindow;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_138 = new QuestHelp(this);
      }
      ...
      private function reset() : void
      {
         ...
         if(this.var_354)
         {
            ...
            {
               this.var_299.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_354 = null;
            this.var_299.destroyListItems();
            this.var_299.removeListItems();
         }
         this.var_497 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_160 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1373 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_299 = this._window.findChildByName("quests") as IItemListWindow;
         ...
         this.var_1373.findChildByName("currency.amount").caption = "${quest_" + this.var_1738 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_738 = this._window.findChildByName("help.button") as IWindowContainer;
         this.var_1131 = this._window.findChildByName("help.container") as IRegionWindow;
         if(this.var_1131)
         {
            this.var_1131.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1131.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1131.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
         if(this.var_738)
         {
            this.var_738.color = 14737632;
         }
      }
      
      public function attachTo(param1:IWindowContainer) : void
      {
         if(this.var_688 || !this._window)
         {
            return;
         }
         ...
         if(this.var_160)
         {
            this.var_160.height = this._window.height - this.var_160.y * 2;
            if(this.var_195)
            {
               this.var_195.view.height = this.var_160.height;
            }
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_497)
         {
            this.var_497.selected = false;
         }
         if(this.var_138)
         {
            this.var_160.addChild(this.var_138.view);
         }
         if(this.var_160)
         {
            this.var_160.height = this._window.height - this.var_160.y * 2;
            if(this.var_138.view)
            {
               this.var_138.view.height = this.var_160.height;
            }
         }
      }
      ...
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1671);
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_299.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_47 || _loc4_.status == QuestStatusEnum.const_571))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_299.maxScrollV > 0)
            {
               this.var_299.scrollV = _loc3_.view.y / this.var_299.maxScrollV;
            }
         }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_497 = param1;
         this.var_497.selected = true;
         this.showQuestData(this.var_497);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_195 = new QuestView(this,param1);
         this.var_160.addChild(this.var_195.view);
         this.var_195.init();
         this.var_160.height = this._window.height - this.var_160.y * 2;
         this.var_195.view.height = this.var_160.height;
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_739.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_739.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_739.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc6_ = this.var_299.getListItemIndex(_loc2_.view);
            this.var_299.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_299.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_299.addListItem(_loc5_.view);
            }
            if(this.var_497 == _loc2_)
            {
