package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_257:QuestCampaign;
      ...
      {
         if(this.var_653 != MODE_TABS)
         {
            this.var_653 = MODE_NO_TABS;
         }
         this.detachCampaign();
         ...
         this.var_257 = _loc4_;
         this.var_257.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
         if(this.var_653 == MODE_TABS)
         {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_257.attachTo(this.var_1104);
         var _loc1_:String = "quest_" + this.var_257.code;
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1104 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_156.getKeys())
         {
            ...
            if(!_loc2_)
            {
               ...
               _loc2_ = this.var_65.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_510) as ITabButtonWindow;
               if(_loc3_.expired)
               {
