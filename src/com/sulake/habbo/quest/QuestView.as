package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1613:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_91.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               this.var_16 = this.var_58.controller.questEngine.getXmlWindow("QuestTypeFindStuff");
               this.var_1613 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            case QuestTypeEnum.GIVE_BADGE:
               this.var_16 = this.var_58.controller.questEngine.getXmlWindow("QuestTypeGiveBadge");
               this.var_1613 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            default:
         ...
         this.var_16.addEventListener(WindowEvent.const_51,this.onResized);
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_91)
         {
            this.var_58.controller.activateQuest(this.var_91);
         }
      }
      ...
      public function onRewardInfo(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(this.var_91)
         {
            _loc3_ = "catalog.page.quest." + this.var_58.code;
            Logger.log("Questing->Open Catalog: " + _loc3_);
            this.var_58.controller.questEngine.openCatalog(_loc3_);
         }
      ...
      private function localize() : void
      {
         ...
         var _loc38_:* = null;
         var _loc39_:* = null;
         var _loc1_:String = ["quest",this.var_58.code,this.var_91.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_58.code,"type_" + this.var_91.type.toLowerCase()].join(".");
         var _loc3_:String = "quest_" + this.var_58.code;
         ...
         {
            _loc34_ = this.var_91.roomItemTypeName.split("*");
            _loc35_ = _loc34_.length > 0 ? _loc34_[0] : "";
            _loc36_ = _loc34_.length > 1 ? int(parseInt(_loc34_[1])) : 0;
            _loc37_ = this.var_58.controller.questEngine.sessionDataManager.getFloorItemDataByName(_loc35_,_loc36_);
            if(_loc37_)
            {
               _loc39_ = "";
               _loc38_ = this.var_58.controller.questEngine.roomEngine.getFurnitureImage(_loc37_.id,new Vector3d(90,0,0),64,this,_loc36_,_loc39_);
               this.var_1612 = _loc38_.id;
               if(_loc38_ && _loc38_.data)
               {
                  this.imageReady(_loc38_.id,_loc38_.data);
               }
               this.var_58.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc37_.title);
            }
         }
         else if(this.var_91.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            this.var_58.controller.questEngine.setImageFromAsset(_loc15_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else if(this.var_91.type == QuestTypeEnum.GIVE_BADGE)
         {
            this.var_58.controller.questEngine.setImageFromAsset(_loc15_,this.var_91.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else
         {
            this.var_1612 = -1;
         ...
         this.var_58.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_91.rewardCurrencyAmount.toString());
         ...
         this.var_58.controller.questEngine.localization.registerParameter("quest.available","day",_loc20_.toString());
         this.var_58.controller.questEngine.localization.registerParameter("quest.available","month",_loc21_.toString());
         this.var_58.controller.questEngine.localization.registerParameter("quest.available","year",_loc22_.toString());
         this.var_58.controller.questEngine.localization.registerParameter("quest.available","12h",this.pad(_loc25_));
         this.var_58.controller.questEngine.localization.registerParameter("quest.available","24h",this.pad(_loc24_));
         this.var_58.controller.questEngine.localization.registerParameter("quest.available","ampm",_loc26_);
         this.var_58.controller.questEngine.localization.registerParameter("quest.available","minute",this.pad(_loc23_));
         ...
         var _loc30_:String = "header_" + this.var_58.code;
         this.var_58.controller.questEngine.setImageFromAsset(_loc29_,_loc30_,this.onHeaderImageReady);
         var _loc31_:IBitmapWrapperWindow = this.find("quest.reward.icon") as IBitmapWrapperWindow;
         var _loc32_:String = "icon_" + this.var_58.code + "_reward_" + this.var_91.rewardCurrencyAmount;
         this.var_58.controller.questEngine.setImageFromAsset(_loc31_,_loc32_,this.onRewardImageReady);
         this.updateMargins();
         var _loc33_:IWindow = this.find("quest.reward.desc");
         if(_loc33_)
         {
            this.var_567 = new Timer(20,1);
            this.var_567.addEventListener(TimerEvent.TIMER,this.onShowReward);
            this.var_567.start();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_795;
            }
         }
      }
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_58.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
      ...
      private function onHeaderImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_58.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onHeaderImageReady);
         }
      }
