package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_347:IRoomObjectController;
      ...
      {
         if(this.var_347 == param1)
         {
            return;
         }
         if(this.var_347 != null)
         {
            this.var_347.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_347 = param1;
            this.var_347.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_347 != null)
            {
               this.var_347.setLocation(param1.loc);
               this.var_347.setDirection(param1.dir);
            }
         }
      }
   }
