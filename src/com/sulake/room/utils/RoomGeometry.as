package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1125:Number = 32;
      ...
      private var var_1562:Number = 1.0;
      ...
      private var var_2811:Number = -500.0;
      
      private var var_2812:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1046 = new Vector3d();
         this.var_1561 = 1;
         this.var_1562 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1560 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_149.x,this.var_149.y,this.var_149.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_80.x * this.var_401,this.var_80.y * this.var_400,this.var_80.z * this.var_399);
      }
      ...
      {
         if(this.var_401 != param1 * this.var_1561)
         {
            this.var_401 = param1 * this.var_1561;
            ++this.var_147;
         }
      }
      ...
      {
         if(this.var_400 != param1 * this.var_1562)
         {
            this.var_400 = param1 * this.var_1562;
            ++this.var_147;
         }
      }
      ...
      {
         if(this.var_399 != param1 * this.var_1560)
         {
            this.var_399 = param1 * this.var_1560;
            ++this.var_147;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_80.x /= this.var_401;
         this.var_80.y /= this.var_400;
         this.var_80.z /= this.var_399;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_148.assign(_loc24_);
            this.var_149.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_148.assign(_loc19_);
            this.var_149.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_471 != null)
         {
            ...
            this.var_471.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_471.add(_loc3_,_loc4_);
            ++this.var_147;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_471 != null)
         {
            ...
            return this.var_471.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1046.assign(_loc22_);
         }
         else
         {
            this.var_1046.assign(_loc17_);
         }
         ++this.var_147;
      }
      ...
      {
         if(param1 == null || this.var_149 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_149,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_148);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_149);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_401;
         _loc2_.y *= this.var_400;
         _loc2_.z *= this.var_399;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1046);
         if(_loc3_ < this.var_2811 || _loc3_ > this.var_2812)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_148);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_400;
            _loc2_.z *= this.var_399;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1046);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_148,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_80.x * this.var_401,this.var_80.y * this.var_400,this.var_80.z * this.var_399);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_149;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_401,param2.y * this.var_400,param2.z * this.var_399);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_401,param3.y * this.var_400,param3.z * this.var_399);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_401,param4.y * this.var_400,param4.z * this.var_399);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1125;
         }
         else
         {
            this.scale = const_684;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_684;
      }
